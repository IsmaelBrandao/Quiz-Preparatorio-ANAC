...
const quizDataSistAvCivilN1 = [
  ...
  { question: "O que é um 'INSPAC'?", options: ["Um investigador de acidentes do CENIPA.", "Um controlador de voo do DECEA.", "Um funcionário da ANAC (civil ou militar) credenciado para fiscalizar empresas, seja em rampa, a bordo ou em terra.", "Um engenheiro do DCTA."], answer: "Um funcionário da ANAC (civil ou em terra." },

...
const quizDataSegVooN1 = [
  { question: "Qual é o objetivo principal da Segurança de Voo, conforme definido no documento?", options: ["Punir organizações e indivíduos responsáveis por incidentes.", "Garantir que todos os voos operem com lucro máximo.", "Prevenir a ocorrência de acidentes, incidentes graves e incidentes aeronáuticos.", "Reduzir os custos de manutenção das aeronaves."], answer: "Prevenir a ocorrência de acidentes, incidentes graves e incidentes aeronáuticos." },
  { question: "De acordo com a definição da OACI (ICAO) apresentada, o que é 'Segurança Operacional' (Safety)?", options: ["Um estado de ausência total e absoluta de qualquer risco.", "Um processo para garantir que apenas aeronaves novas possam voar.", "Estado no qual o risco de lesões às pessoas ou danos aos bens se reduz e se mantém em um nível aceitável, ou abaixo deste, por meio de um processo contínuo de identificação de perigos e gestão de riscos.", "A investigação focada exclusivamente em culpar os envolvidos após um acidente."], answer: "Estado no qual o risco de lesões às pessoas ou danos aos bens se reduz e se mantém em um nível aceitável, ou abaixo deste, por meio de um processo contínuo de identificação de perigos e gestão de riscos." },
  { question: "No Brasil, qual é o órgão central responsável pela investigação e prevenção de acidentes aeronáuticos?", options: ["ANAC (Agência Nacional de Aviação Civil)", "DECEA (Departamento de Controle do Espaço Aéreo)", "CENIPA (Centro de Investigação e Prevenção de Acidentes Aeronáuticos)", "SERIPA (Serviços Regionais de Investigação e Prevenção)"], answer: "CENIPA (Centro de Investigação e Prevenção de Acidentes Aeronáuticos)" },
  { question: "Qual é o propósito fundamental da Filosofia SIPAER na investigação de um acidente, segundo o Anexo 13 da OACI?", options: ["Determinar a culpa e a responsabilidade civil ou criminal.", "A prevenção de futuros acidentes, não sendo seu propósito determinar culpa ou responsabilidade.", "Calcular o valor das indenizações que devem ser pagas pelas seguradoras.", "Estabelecer um ranking de segurança entre as companhias aéreas."], answer: "A prevenção de futuros acidentes, não sendo seu propósito determinar culpa ou responsabilidade." },
  { question: "Qual princípio da Filosofia SIPAER é contrariado pela ideia de punição?", options: ["Todo acidente pode ser evitado.", "Todo acidente aeronáutico tem um precedente.", "Prevenção de acidentes requer mobilização geral.", "Acusações e punições de erros humanos agem contra os interesses da prevenção."], answer: "Acusações e punições de erros humanos agem contra os interesses da prevenção." },
  { question: "Uma ocorrência é classificada como 'Acidente Aeronáutico' quando, entre outros critérios:", options: ["Há apenas danos leves no motor ou na hélice.", "A aeronave sofre dano ou falha estrutural que afete a resistência, o desempenho ou as características de voo.", "Ocorre qualquer falha de equipamento que não afeta a segurança.", "A tripulação decide retornar ao aeroporto de origem por precaução."], answer: "A aeronave sofre dano ou falha estrutural que afete a resistência, o desempenho ou as características de voo." },
  { question: "Como o documento define um 'Incidente Aeronáutico'?", options: ["Qualquer ocorrência em que a aeronave é considerada desaparecida.", "Uma ocorrência, não classificada como acidente, associada à operação de uma aeronave que afete ou possa afetar a segurança da operação.", "Um evento que resulta em lesão grave ou fatal para uma pessoa a bordo.", "Exclusivamente uma ocorrência de solo relacionada a serviços de rampa."], answer: "Uma ocorrência, não classificada como acidente, associada à operação de uma aeronave que afete ou possa afetar a segurança da operação." },
  { question: "O que diferencia um 'Incidente Aeronáutico Grave' de um 'Acidente Aeronáutico'?", options: ["O incidente grave nunca é investigado pelo CENIPA.", "A diferença está apenas nas consequências; o incidente grave indica elevado potencial de risco, mas não resultou nas consequências de um acidente.", "O incidente grave só se aplica a aeronaves de grande porte (RBAC 121).", "Não há diferença, os termos são intercambiáveis."], answer: "A diferença está apenas nas consequências; o incidente grave indica elevado potencial de risco, mas não resultou nas consequências de um acidente." },
  { question: "O que significa a sigla F.O.D. no contexto da segurança operacional?", options: ["Fator de Operação Deficiente.", "Dano por Objeto Estranho (Foreign Object Damage).", "Falha Operacional Documentada.", "Formulário de Observação de Desvio."], answer: "Dano por Objeto Estranho (Foreign Object Damage)." },
  { question: "Quais são as três áreas de investigação (Fatores) que o SIPAER utiliza para averiguar os fatores contribuintes de uma ocorrência?", options: ["Fator Econômico, Fator Político e Fator Social.", "Fator de Projeto, Fator de Voo e Fator de Pouso.", "Fator Humano, Fator Material e Fator Operacional.", "Fator ANAC, Fator DECEA e Fator CENIPA."], answer: "Fator Humano, Fator Material e Fator Operacional." },
  { question: "O que é uma 'Ocorrência de Solo'?", options: ["Qualquer acidente que ocorra durante o pouso.", "Uma ocorrência com danos ou lesões, relacionada aos serviços de rampa, e que não teve contribuição da movimentação da aeronave por meios próprios.", "Um incidente durante o táxi da aeronave para decolagem.", "Quando uma aeronave é danificada por condições meteorológicas enquanto estacionada."], answer: "Uma ocorrência com danos ou lesões, relacionada aos serviços de rampa, e que não teve contribuição da movimentação da aeronave por meios próprios." },
  { question: "Qual documento é um reporte voluntário (RELPREV) ou um relato ao CENIPA (RCSV) destinado a reportar o quê?", options: ["Apenas acidentes já ocorridos.", "Uma situação potencial de risco para a segurança operacional.", "Reclamações sobre o serviço de bordo.", "A culpa de um tripulante em um incidente."], answer: "Uma situação potencial de risco para a segurança operacional." },
  { question: "Qual é o status do Relatório Final (RF) de uma investigação do CENIPA?", options: ["Secreto, acessível apenas pelo poder judiciário.", "Sigiloso, disponível apenas para a companhia aérea envolvida.", "Ostensivo e divulgado publicamente na internet para fins de prevenção.", "Disponível apenas para os familiares das vítimas."], answer: "Ostensivo e divulgado publicamente na internet para fins de prevenção." },
  { question: "O que é uma 'Recomendação de Segurança' (RSV)?", options: ["Uma ordem de punição imediata para os envolvidos.", "Uma determinação de culpa ou responsabilidade.", "Uma proposta, baseada na investigação, feita com a intenção de prevenir novas ocorrências, sem criar presunção de culpa.", "Um documento que obriga a companhia aérea a pagar indenizações."], answer: "Uma proposta, baseada na investigação, feita com a intenção de prevenir novas ocorrências, sem criar presunção de culpa." },
  { question: "De acordo com o Art. 261 do Código Penal Brasileiro, mencionado no PDF, qual é a consequência de apontar um raio laser para uma aeronave?", options: ["É uma prática permitida se o laser for de baixa potência.", "É considerado um ato de 'boas-vindas' no aeroporto.", "É um ato que pode causar distração ou cegueira momentânea e é enquadrado como crime com pena de reclusão.", "Resulta apenas em uma multa administrativa leve."], answer: "É um ato que pode causar distração ou cegueira momentânea e é enquadrado como crime com pena de reclusão." },
  { question: "De acordo com a definição de 'Lesão Grave', qual é o critério de tempo para hospitalização após a ocorrência?", options: ["Mais de 24 horas, no período de 3 dias.", "Mais de 48 horas, no período de 7 dias.", "Mais de 72 horas, a qualquer momento.", "Exatamente 48 horas, no período de 5 dias."], answer: "Mais de 48 horas, no período de 7 dias." },
  { question: "Em conformidade com o Anexo 13 da OACI, uma lesão é considerada 'Fatal' se a fatalidade ocorrer em até quantos dias após a data da ocorrência?", options: ["10 dias", "60 dias", "30 dias", "7 dias"], answer: "30 dias" },
  { question: "Qual das seguintes situações é explicitamente listada como uma EXCEÇÃO e NÃO seria classificada como 'Acidente Aeronáutico'?", options: ["Danos limitados a um único motor, suas carenagens ou acessórios.", "Aeronave que despressuriza devido a dano estrutural.", "Separação de um motor da aeronave.", "Dano que afeta a resistência estrutural ou o desempenho de voo."], answer: "Danos limitados a um único motor, suas carenagens ou acessórios." },
  { question: "Quando uma aeronave é considerada 'desaparecida' para fins de classificação de acidente?", options: ["Após 24 horas sem contato.", "Quando as buscas oficiais forem encerradas e os destroços não forem encontrados.", "Assim que o sinal do ELT para de transmitir.", "Imediatamente após a comunicação de emergência."], answer: "Quando as buscas oficiais forem encerradas e os destroços não forem encontrados." },
  { question: "Segundo o documento, qual é a principal diferença entre um 'Incidente Aeronáutico Grave' e um 'Acidente Aeronáutico'?", options: ["O Incidente Grave só é investigado pelo SERIPA.", "A diferença está apenas nas consequências.", "O Incidente Grave não requer emissão de Relatório Final.", "O Acidente envolve aeronaves RBAC 121 e o Incidente Grave não."], answer: "A diferença está apenas nas consequências." },
  { question: "Qual dos seguintes é um exemplo de 'Incidente Aeronáutico Grave' listado no Adendo C do Anexo 13?", options: ["Pequenas perfurações no revestimento por granizo.", "Falha de um sistema de entretenimento a bordo.", "Fogo ou fumaça no cockpit, mesmo que tenha sido apagado por agentes extintores.", "Ocorrência de solo durante o serviço de rampa."], answer: "Fogo ou fumaça no cockpit, mesmo que tenha sido apagado por agentes extintores." },
  { question: "Para que uma ocorrência seja classificada como 'Ocorrência de Solo', qual condição é essencial?", options: ["A aeronave deve estar em movimento por meios próprios.", "Deve ocorrer durante o pouso ou decolagem.", "Não pode ter havido qualquer contribuição da movimentação da aeronave por meios próprios ou da operação de seus sistemas.", "O dano deve ser classificado como 'grave' pela OACI."], answer: "Não pode ter havido qualquer contribuição da movimentação da aeronave por meios próprios ou da operação de seus sistemas." },
  { question: "Quando o uso do 'RCSV' (Relato ao CENIPA para Segurança de Voo) é indicado em vez do 'RELPREV'?", options: ["Quando o relator deseja receber uma recompensa.", "Para relatar exclusivamente acidentes já ocorridos.", "Quando a cultura da organização envolvida não está em consonância com os princípios do SIPAER ou se deseja preservar a identidade do relator.", "Para reportar danos causados por FOD, que são de responsabilidade do aeródromo."], answer: "Quando a cultura da organização envolvida não está em consonância com os princípios do SIPAER ou se deseja preservar a identidade do relator." },
  { question: "Sobre o 'Relatório Final' (RF) emitido pelo CENIPA, é correto afirmar que:", options: ["Ele estabelece o grau de contribuição de cada fator e apura a responsabilidade civil.", "Ele não decorre do contraditório e da ampla defesa e não visa apurar responsabilidade.", "É um documento sigiloso que não pode ser acessado pelo público.", "Ele só é emitido em casos de Acidente, nunca em Incidentes Graves."], answer: "Ele não decorre do contraditório e da ampla defesa e não visa apurar responsabilidade." },
  { question: "No caso de uma 'Recomendação de Segurança' (RSV) para um provedor de serviço de aviação civil (PSAC) regulado, como uma Cia Aérea, quem será o destinatário da recomendação emitida pelo CENIPA?", options: ["O SERIPA da região da ocorrência.", "O operador da aeronave diretamente.", "O Comitê Nacional de Prevenção de Acidentes Aeronáuticos (CNPAA).", "A ANAC."], answer: "A ANAC." },
  { question: "A investigação do 'Fator Humano' pelo SIPAER busca averiguar, de forma sistemática, quais dois aspectos do complexo biopsicossocial?", options: ["Aspecto Técnico e Aspecto Comportamental.", "Aspecto Médico e Aspecto Psicológico.", "Aspecto de Treinamento e Aspecto de Fadiga.", "Aspecto Social e Aspecto Econômico."], answer: "Aspecto Médico e Aspecto Psicológico." },
  { question: "A investigação do 'Fator Operacional' busca averiguar fatores contribuintes relacionados a quê?", options: ["Exclusivamente ao projeto e fabricação da aeronave.", "Ao desempenho técnico do ser humano, à infraestrutura aeroportuária e à infraestrutura de tráfego aéreo.", "Apenas às condições meteorológicas no momento da ocorrência.", "Às condições psicológicas da tripulação antes do voo."], answer: "Ao desempenho técnico do ser humano, à infraestrutura aeroportuária e à infraestrutura de tráfego aéreo." },
  { question: "De acordo com o Art. 87 do Código Brasileiro de Aeronáutica (CBA), de quem é a responsabilidade pela prevenção de acidentes aeronáuticos?", options: ["Exclusivamente do CENIPA e dos órgãos do SIPAER.", "Apenas dos pilotos e operadores de aeronaves.", "De todas as pessoas, naturais ou jurídicas, envolvidas com a fabricação, manutenção, operação e infraestrutura.", "Somente da ANAC, como órgão regulador."], answer: "De todas as pessoas, naturais ou jurídicas, envolvidas com a fabricação, manutenção, operação e infraestrutura." },
  { question: "Após a liberação dos destroços pela investigação, se o operador da aeronave não dispuser de meios para a remoção, quem a realizará?", options: ["O CENIPA, como parte da investigação.", "A administração responsável pelo aeródromo, sem se responsabilizar por danos dela decorrentes.", "A autoridade policial local, para fins de perícia.", "Os destroços não podem ser removidos até a conclusão do Relatório Final."], answer: "A administração responsável pelo aeródromo, sem se responsabilizar por danos dela decorrentes." },
  { question: "Se os destroços de uma aeronave acidentada se encontrarem em lugar de difícil acesso e não puderem ser removidos, qual procedimento deve ser adotado?", options: ["Devem ser cobertos para evitar curiosos.", "Devem ser pintados na cor amarela.", "Devem ser deixados como estão, sem nenhuma marcação.", "Devem ser destruídos com explosivos obrigatoriamente."], answer: "Devem ser pintados na cor amarela." },
  { question: "O que é um 'Elo-SIPAER'?", options: ["A ligação de comunicação entre o piloto e a torre de controle.", "O profissional certificado pelo CENIPA, como OSV ou ASV.", "Órgão, setor ou cargo, dentro de uma organização, responsável pelos assuntos de segurança de voo no âmbito do SIPAER.", "A caixa-preta da aeronave."], answer: "Órgão, setor ou cargo, dentro de uma organização, responsável pelos assuntos de segurança de voo no âmbito do SIPAER." },
  { question: "Qual a diferença fundamental entre um 'Oficial de Segurança de Voo (OSV)' e um 'Agente de Segurança de Voo (ASV)'?", options: ["O OSV investiga acidentes e o ASV apenas incidentes.", "O OSV é militar da ativa das Forças Armadas ou Auxiliares, e o ASV é civil ou militar da reserva.", "O OSV pode emitir Recomendações de Segurança e o ASV não.", "Não há diferença, os termos são usados para o mesmo profissional."], answer: "O OSV é militar da ativa das Forças Armadas ou Auxiliares, e o ASV é civil ou militar da reserva." },
  { question: "O que é a 'Ação Inicial' em uma investigação SIPAER?", options: ["A primeira comunicação do piloto sobre a emergência.", "O relatório preliminar enviado à OACI.", "Medidas preliminares no local da ocorrência para coleta de dados e preservação de indícios.", "A entrevista inicial com os sobreviventes no hospital."], answer: "Medidas preliminares no local da ocorrência para coleta de dados e preservação de indícios." },
  { question: "Exceto para salvar vidas, quem tem autoridade para vasculhar ou remover destroços de uma aeronave acidentada?", options: ["Apenas a autoridade policial e o operador da aeronave.", "Apenas com autorização do Investigador-Encarregado.", "Qualquer membro de uma equipe de resgate credenciada.", "A companhia de seguros, para avaliar os danos."], answer: "Apenas com autorização do Investigador-Encarregado." },
  { question: "A quem compete a responsabilidade pela 'Comunicação da ocorrência aos familiares das vítimas'?", options: ["Ao CENIPA, como órgão investigador central.", "Ao Investigador-Encarregado designado para o caso.", "Ao operador ou explorador da aeronave.", "Ao Centro de Comunicação Social da Aeronáutica (CECOMSAER)."], answer: "Ao operador ou explorador da aeronave." },
  { question: "De quem é a responsabilidade pelo 'transporte dos restos mortais' de vítimas de um acidente?", options: ["Do SALVAERO.", "Do CENIPA.", "Da autoridade policial local.", "Do operador ou explorador da aeronave."], answer: "Do operador ou explorador da aeronave." },
  { question: "O que o documento define como 'Fator Contribuinte'?", options: ["A causa única e principal que levou ao acidente.", "Qualquer pessoa que tenha cometido um erro durante a operação.", "Ação, omissão, evento ou condição que, se eliminada, poderia ter reduzido a probabilidade ou a severidade da ocorrência.", "A falha material ou de projeto da aeronave."], answer: "Ação, omissão, evento ou condição que, se eliminada, poderia ter reduzido a probabilidade ou a severidade da ocorrência." },
  { question: "O que é o 'Relatório Final Simplificado'?", options: ["É o mesmo que o Reporte Preliminar (RP).", "Um relatório adotado quando os elementos da investigação não demandam o detalhamento completo de um RF.", "Um documento usado apenas para Ocorrências de Solo.", "Um relatório que não contém Recomendações de Segurança."], answer: "Um relatório adotado quando os elementos da investigação não demandam o detalhamento completo de um RF." },
  { question: "Quando o CENIPA disponibilizará um 'Reporte Intermediário' (Interim Statement)?", options: ["Sempre 30 dias após o acidente.", "Se a investigação não for finalizada em até um ano após a data da ocorrência.", "Apenas se for solicitado pela OACI.", "Somente em casos de aeronaves desaparecidas."], answer: "Se a investigação não for finalizada em até um ano após a data da ocorrência." },
  { question: "O que é um 'Representante Acreditado'?", options: ["Um advogado nomeado pelas famílias das vítimas.", "Um porta-voz da companhia aérea autorizado a falar sobre o acidente.", "Pessoa designada por um Estado para participar de uma investigação conduzida por outro Estado.", "O Investigador-Encarregado nomeado pelo CENIPA."], answer: "Pessoa designada por um Estado para participar de uma investigação conduzida por outro Estado." },
  { question: "Qual a finalidade principal do 'Checklist' na aviação, segundo o documento?", options: ["Treinar novos pilotos em procedimentos complexos.", "Garantir que nenhum procedimento ou item seja esquecido, já que a aviação não deixa espaço para erros.", "Apenas cumprir uma exigência burocrática da ANAC.", "Reduzir o tempo de permanência da aeronave no solo."], answer: "Garantir que nenhum procedimento ou item seja esquecido, já que a aviação não deixa espaço para erros." },
  { question: "O que significa o 'Risco Baloeiro' para a aviação?", options: ["Um risco baixo, pois os balões são leves e se desintegram facilmente.", "Um risco potencial de ingestão pelo motor ou danos estruturais pelo impacto.", "Um risco exclusivo de incêndio em solo, não afetando o voo.", "Uma prática cultural permitida em áreas designadas."], answer: "Um risco potencial de ingestão pelo motor ou danos estruturais pelo impacto." },
  { question: "O que é o 'Comitê Nacional de Prevenção de Acidentes Aeronáuticos (CNPAA)'?", options: ["O nome antigo do CENIPA.", "Uma entidade interministerial que reúne diversos segmentos da aviação para discutir soluções para a segurança de voo.", "Um comitê internacional sediado em Chicago.", "O órgão responsável por julgar a culpa em acidentes aéreos."], answer: "Uma entidade interministerial que reúne diversos segmentos da aviação para discutir soluções para a segurança de voo." },
  { question: "Qual é a finalidade da 'Vistoria de Segurança de Voo'?", options: ["Punir os funcionários que não seguem os procedimentos.", "Fornecer aos Chefes ou Diretores uma análise de situações de perigo real ou potencial para desencadear ações corretivas.", "Verificar se as licenças dos pilotos estão em dia.", "Estabelecer o valor de seguro da aeronave."], answer: "Fornecer aos Chefes ou Diretores uma análise de situações de perigo real ou potencial para desencadear ações corretivas." },
  { question: "O que é um 'Incidente de Tráfego Aéreo (AIRPROX)'?", options: ["Qualquer falha nos equipamentos do controle de tráfego aéreo.", "Uma situação em que a proximidade entre aeronaves foi tal que a segurança foi comprometida.", "O congestionamento de aeronaves no pátio do aeroporto.", "Um erro de comunicação entre o piloto e o controlador."], answer: "Uma situação em que a proximidade entre aeronaves foi tal que a segurança foi comprometida." },
  { question: "O que é o SGSO (Safety Management System), implantado pela OACI em 2009?", options: ["Um software de simulação de voo para treinamento de emergências.", "O sistema de investigação de acidentes dos EUA (NTSB).", "Um sistema que amplia o conceito de segurança para uma abordagem sistêmica, promovendo a melhoria contínua.", "Um regulamento que proíbe o voo de aeronaves com mais de 20 anos."], answer: "Um sistema que amplia o conceito de segurança para uma abordagem sistêmica, promovendo a melhoria contínua." },
  { question: "A investigação do 'Fator Material' busca averiguar o quê?", options: ["O custo financeiro do acidente e o valor dos danos.", "As condições de aeronavegabilidade, incluindo projeto, fabricação e manuseio do material.", "Os materiais perigosos transportados no compartimento de carga.", "A qualidade do combustível utilizado na aeronave."], answer: "As condições de aeronavegabilidade, incluindo projeto, fabricação e manuseio do material." },
  { question: "O que acontecerá se o Investigador-Encarregado constatar indícios de crime durante a investigação SIPAER?", options: ["Ele deve interromper a investigação SIPAER e assumir a investigação criminal.", "Ele deve ignorar, pois a investigação SIPAER foca apenas na prevenção.", "Ele deve comunicar à autoridade policial competente.", "Ele deve finalizar o Relatório Final e anexar os indícios de crime."], answer: "Ele deve comunicar à autoridade policial competente." },
  { question: "A quem pertence a 'Assessoria de Segurança Operacional (ASSOP)', destacada no organograma do PDF?", options: ["Ao CENIPA.", "Ao DECEA.", "À ANAC.", "À OACI."], answer: "À ANAC." },
  { question: "No que diz respeito à Fadiga, o que o RBAC 117 (mencionado pelo professor) obriga o tripulante a fazer?", options: ["Trabalhar até 20 horas seguidas se necessário.", "Utilizar os períodos de repouso para obter sono suficiente e informar ao operador se não estiver em condições de voo.", "Tomar medicamentos estimulantes para se manter alerta.", "Nunca relatar fadiga para evitar punições da empresa."], answer: "Utilizar os períodos de repouso para obter sono suficiente e informar ao operador se não estiver em condições de voo." }
];

const quizDataSegVooN2 = [
  { question: "Qual é o documento básico da OACI que contém os padrões e procedimentos recomendados para investigação e prevenção de acidentes?", options: ["Doc 9859 (Manual de Gerenciamento da Segurança)", "Anexo 19 (Gestão da Segurança Operacional)", "Anexo 13 (Investigação e Prevenção de Acidentes Aeronáuticos)", "Anexo 6 (Operação de Aeronaves)"], answer: "Anexo 13 (Investigação e Prevenção de Acidentes Aeronáuticos)" },
  { question: "De acordo com o CBA (Lei nº 7.565/86), o SIPAER integra qual estrutura?", options: ["O Ministério da Defesa.", "A infraestrutura aeronáutica.", "A Agência Nacional de Aviação Civil (ANAC).", "O Departamento de Controle do Espaço Aéreo (DECEA)."], answer: "A infraestrutura aeronáutica." },
  { question: "Segundo o Art. 86 do CBA, qual é a competência do SIPAER?", options: ["Regular e fiscalizar a aviação civil.", "Homologar aeronaves e aeródromos.", "Planejar, orientar, coordenar, controlar e executar as atividades de Investigação e de Prevenção de Acidentes.", "Prestar serviços de tráfego aéreo e telecomunicações."], answer: "Planejar, orientar, coordenar, controlar e executar as atividades de Investigação e de Prevenção de Acidentes." },
  { question: "Como era a filosofia de investigação no Brasil antes da nova abordagem do SIPAER?", options: ["Focada na prevenção e sem busca de culpados.", "Baseada na busca de responsabilidades e culpados através de Comissões de Inquéritos Sumários.", "Conduzida exclusivamente por companhias estrangeiras.", "Inexistente, acidentes não eram investigados."], answer: "Baseada na busca de responsabilidades e culpados através de Comissões de Inquéritos Sumários." },
  { question: "Qual é a garantia legal de toda informação prestada em proveito de uma investigação SIPAER?", options: ["Será usada para fins judiciais e de punição.", "Será mantida em sigilo por 50 anos.", "Seu exclusivo uso para fins de prevenção.", "Será compartilhada publicamente na íntegra."], answer: "Seu exclusivo uso para fins de prevenção." },
  { question: "Qual princípio da Filosofia SIPAER afirma que todo acidente aeronáutico nunca resulta de uma única causa?", options: ["Todo acidente pode ser evitado.", "Todo acidente aeronáutico resulta de vários eventos e nunca de uma causa isolada.", "Todo acidente aeronáutico tem um precedente.", "Prevenção de acidentes requer mobilização geral."], answer: "Todo acidente aeronáutico resulta de vários eventos e nunca de uma causa isolada." },
  { question: "Segundo a Filosofia SIPAER, quem é o principal responsável pela prevenção de acidentes aeronáuticos em uma organização?", options: ["O Agente de Segurança de Voo (ASV).", "A tripulação de voo.", "A equipe de manutenção.", "A Alta Direção."], answer: "A Alta Direção." },
  { question: "Qual princípio da Filosofia SIPAER é vital para a cooperação internacional e a troca de informações?", options: ["O propósito da prevenção não é restringir a atividade aérea.", "Na prevenção de acidentes não há segredos nem bandeiras.", "Todo acidente pode ser evitado.", "A alta direção é a principal responsável."], answer: "Na prevenção de acidentes não há segredos nem bandeiras." },
  { question: "Os SERIPA são subordinados administrativamente a quem?", options: ["Ao CENIPA.", "Aos Comandos Aéreos Regionais (COMAR).", "À ANAC.", "Ao DECEA."], answer: "Aos Comandos Aéreos Regionais (COMAR)." },
  { question: "Os SERIPA são subordinados técnica e operacionalmente a quem?", options: ["Ao CENIPA.", "Aos Comandos Aéreos Regionais (COMAR).", "À ANAC.", "Ao DECEA."], answer: "Ao CENIPA." },
  { question: "Dentro da estrutura da ANAC, qual é a assessoria que trata da interface com o CENIPA e controla o cumprimento das Recomendações de Segurança?", options: ["Procuradoria (PGFPF)", "Assessoria Técnica (ASTEC)", "Assessoria de Segurança Operacional (ASSOP)", "Corregedoria (CRG)"], answer: "Assessoria de Segurança Operacional (ASSOP)" },
  { question: "Em que data a OACI implantou efetivamente o SMS (SGSO)?", options: ["7 de dezembro de 1944", "1º de janeiro de 2009", "19 de dezembro de 1986", "Em 1971, com a criação do CENIPA"], answer: "1º de janeiro de 2009" },
  { question: "A criação do CENIPA em 1971 marcou uma mudança de filosofia, onde a palavra 'inquérito' foi substituída e as investigações passaram a ter como único objetivo o quê?", options: ["A punição exemplar dos culpados.", "A determinação de responsabilidade civil.", "A promoção da 'prevenção de acidentes aeronáuticos'.", "O cálculo de indenizações."], answer: "A promoção da 'prevenção de acidentes aeronáuticos'." },
  { question: "Qual é o órgão investigador de acidentes de transporte nos Estados Unidos, citado como exemplo no PDF?", options: ["FAA (Federal Aviation Administration)", "EASA (European Union Aviation Safety Agency)", "NTSB (National Transportation Safety Board)", "TSB (Transportation Safety Board of Canada)"], answer: "NTSB (National Transportation Safety Board)" },
  { question: "Para ser um Oficial de Segurança de Voo (OSV), além de ser oficial da ativa, o candidato deve ser:", options: ["Piloto militar ou engenheiro aeronáutico/mecânico das Forças Armadas ou Auxiliares.", "Qualquer oficial com curso superior.", "Controlador de tráfego aéreo com 10 anos de experiência.", "Exclusivamente piloto de caça."], answer: "Piloto militar ou engenheiro aeronáutico/mecânico das Forças Armadas ou Auxiliares." },
  { question: "Para ser um Agente de Segurança de Voo (ASV), o candidato civil deve, entre outros requisitos:", options: ["Ter curso superior em qualquer área.", "Ser piloto comercial, piloto de linha aérea ou engenheiro aeronáuto/mecânico.", "Ser funcionário de aeroporto por mais de 5 anos.", "Ter licença de comissário de voo."], answer: "Ser piloto comercial, piloto de linha aérea ou engenheiro aeronáuto/mecânico." },
  { question: "Como o documento define 'Veículo Aéreo Não Tripulado' (VANT)?", options: ["Qualquer drone, incluindo aeromodelos recreativos.", "Aeronave projetada para operar sem piloto a bordo e que não seja utilizada para fins meramente recreativos.", "Sinônimo de Aeronave Remotamente Pilotada (RPA).", "Um míssil teleguiado."], answer: "Aeronave projetada para operar sem piloto a bordo e que não seja utilizada para fins meramente recreativos." },
  { question: "Como o documento define 'Aeronave Remotamente Pilotada' (RPA)?", options: ["Qualquer drone ou aeromodelo.", "Uma aeronave não tripulada pilotada a partir de uma estação remota, utilizada com propósitos não recreativos.", "Um VANT que opera de forma autônoma sem piloto.", "Um brinquedo de controle remoto."], answer: "Uma aeronave não tripulada pilotada a partir de uma estação remota, utilizada com propósitos não recreativos." },
  { question: "Qual das seguintes lesões NÃO é considerada 'Grave'?", options: ["Hospitalização por mais de 48h (no período de 7 dias).", "Fratura de qualquer osso (exceto fraturas simples dos dedos, nariz).", "Lesões a qualquer órgão interno.", "Queimaduras de primeiro grau em menos de 5% do corpo."], answer: "Queimaduras de primeiro grau em menos de 5% do corpo." },
  { question: "Qual das seguintes situações de dano à aeronave é listada como uma EXCEÇÃO e NÃO seria um acidente?", options: ["A perda de carenagem do motor (Fan/Core) que não resulte em danos adicionais.", "Um motor que se separa da aeronave.", "Dano estrutural que causa despressurização.", "Falha que afeta a resistência estrutural."], answer: "A perda de carenagem do motor (Fan/Core) que não resulte em danos adicionais." },
  { question: "Se uma aeronave pousa sem trem de pouso e resulta apenas em abrasão do revestimento, sendo liberada após pequenos reparos, como a ocorrência é classificada?", options: ["Acidente Aeronáutico.", "Incidente Aeronáutico Grave.", "Não é considerada um acidente.", "Ocorrência de Solo."], answer: "Não é considerada um acidente." },
  { question: "Ocorrências que envolvem evacuação de emergência são consideradas acidentes?", options: ["Sempre, independentemente de danos ou lesões.", "Nunca, pois é um procedimento de segurança.", "Somente se alguém for gravemente ferido ou a aeronave tiver dano significativo.", "Apenas se a evacuação ocorrer fora do aeroporto."], answer: "Somente se alguém for gravemente ferido ou a aeronave tiver dano significativo." },
  { question: "O que é o 'ADREP' (ACCIDENT/INCIDENT DATA REPORTING)?", options: ["O Relatório Final publicado pelo CENIPA.", "O reporte voluntário de prevenção (RELPREV).", "O reporte padronizado, elaborado pelo CENIPA, a ser encaminhado à ICAO sobre a investigação.", "O sistema de gerenciamento de fadiga da tripulação."], answer: "O reporte padronizado, elaborado pelo CENIPA, a ser encaminhado à ICAO sobre a investigação." },
  { question: "Em qual CINDACTA está localizado o Centro Brasileiro de Controle de Missão (BRMCC), responsável por verificar sinais de alerta?", options: ["CINDACTA I (Brasília-DF)", "CINDACTA II (Curitiba-PR)", "CINDACTA III (Recife-PE)", "CINDACTA IV (Manaus-AM)"], answer: "CINDACTA I (Brasília-DF)" },
  { question: "Qual é o nome dos Centros de Coordenação de Salvamento Aeronáutico?", options: ["CENIPA", "BRMCC", "SALVAERO", "SIPAER"], answer: "SALVAERO" },
  { question: "Em voos de ensaio experimental de empresa certificada, uma ocorrência relacionada diretamente ao objetivo do ensaio é classificada como acidente?", options: ["Sim, sempre.", "Não, desde que o CENIPA estabeleça essa relação após análise.", "Sim, mas a investigação é simplificada.", "Apenas se houver fatalidades."], answer: "Não, desde que o CENIPA estabeleça essa relação após análise." },
  { question: "Quando o CENIPA julgar que um 'Incidente Aeronáutico' justifica uma investigação aprofundada com evidências perecíveis, qual procedimento será realizado?", options: ["A emissão imediata de um Relatório Final.", "A Ação Inicial.", "O acionamento do SALVAERO.", "A notificação à OACI apenas."], answer: "A Ação Inicial." },
  { question: "O que é uma 'Ocorrência Anormal'?", options: ["É o mesmo que um Incidente Aeronáutico.", "Uma circunstância que não afeta a segurança, mas exige medidas técnicas corretivas (ex: ar condicionado com defeito).", "Um acidente com aeronave experimental.", "Qualquer reporte voluntário (RELPREV)."], answer: "Uma circunstância que não afeta a segurança, mas exige medidas técnicas corretivas (ex: ar condicionado com defeito)." },
  { question: "Qual dos seguintes é um exemplo de 'Incidente de Tráfego Aéreo' relacionado a 'Facilidades'?", options: ["O piloto não cumprir um procedimento de subida.", "Uma falha em uma instalação de infraestrutura de navegação aérea que causou dificuldades.", "Uma aeronave comprometer a segurança por proximidade (AIRPROX).", "Um erro de comunicação do piloto."], answer: "Uma falha em uma instalação de infraestrutura de navegação aérea que causou dificuldades." },
  { question: "Qual é a definição de 'Fator Contribuinte'?", options: ["A culpa determinada pelo investigador.", "Ação, omissão, evento ou condição que, se eliminada, evitaria ou reduziria a probabilidade/severidade da ocorrência.", "A pessoa responsável pelo erro.", "A falha material que iniciou o evento."], answer: "Ação, omissão, evento ou condição que, se eliminada, evitaria ou reduziria a probabilidade/severidade da ocorrência." },
  { question: "A identificação de um 'Fator Contribuinte' pelo CENIPA implica presunção de culpa ou responsabilidade?", options: ["Sim, é a base para o processo criminal.", "Apenas se for um Fator Humano.", "Não, a identificação não implica culpa ou responsabilidade.", "Sim, mas apenas para fins de seguro."], answer: "Não, a identificação não implica culpa ou responsabilidade." },
  { question: "Segundo o documento, qual é um dos pilares da 'doutrina ou filosofia de trabalho' da segurança de voo?", options: ["Punir erros para evitar repetição.", "Uma atitude pessoal preventiva baseada no Homem, Máquina e Meio.", "Focar a investigação apenas na Máquina (Fator Material).", "Acreditar que acidentes são inevitáveis."], answer: "Uma atitude pessoal preventiva baseada no Homem, Máquina e Meio." },
  { question: "A investigação do 'Fator Humano - Aspecto Médico' busca definir o quê?", options: ["Apenas se o piloto estava com o CMA válido.", "A presença de variáveis médicas ou fisiológicas e sua participação nos eventos.", "Se o piloto estava psicologicamente apto para o voo.", "O nível de treinamento de emergência da tripulação."], answer: "A presença de variáveis médicas ou fisiológicas e sua participação nos eventos." },
  { question: "A investigação do 'Fator Humano - Aspecto Psicológico' foca em quê?", options: ["Apenas em distúrbios mentais pré-existentes.", "Na participação de variáveis psicológicas individuais, psicossociais ou organizacionais no desempenho.", "Se o piloto estava feliz ou triste no dia do voo.", "Exclusivamente no nível de estresse causado pela empresa."], answer: "Na participação de variáveis psicológicas individuais, psicossociais ou organizacionais no desempenho." },
  { question: "A investigação do 'Fator Operacional' analisa o desempenho técnico humano em quais áreas?", options: ["Apenas operação de aeronaves.", "Operação, manutenção e prestação de serviços de tráfego aéreo.", "Apenas manutenção de aeronaves.", "Exclusivamente o cumprimento do RBAC 117 (fadiga)."], answer: "Operação, manutenção e prestação de serviços de tráfego aéreo." },
  { question: "Qual é a finalidade de uma 'Investigação SIPAER'?", options: ["Coleta de dados para punir o operador da aeronave.", "Prevenir acidentes através da coleta, análise, conclusões e emissão de recomendações de segurança.", "Estabelecer o valor da aeronave para fins de seguro.", "Determinar a culpa do piloto para cassação da licença."], answer: "Prevenir acidentes através da coleta, análise, conclusões e emissão de recomendações de segurança." },
  { question: "Em uma investigação SIPAER, entrevistas e declarações são reduzidas a termo (documento formal)?", options: ["Sim, e são usadas como prova judicial.", "Não, são apontamentos informais para incentivar a participação voluntária e preservar a investigação.", "Sim, e são assinadas por advogados.", "Apenas as declarações dos sobreviventes."], answer: "Não, são apontamentos informais para incentivar a participação voluntária e preservar a investigação." },
  { question: "Uma investigação SIPAER tem precedência sobre outras investigações (como a policial)?", options: ["Não, a investigação policial é sempre prioritária.", "Sim, com a finalidade de preservação de indícios para a prevenção.", "Apenas se não houver fatalidades.", "Apenas em acidentes militares."], answer: "Sim, com a finalidade de preservação de indícios para a prevenção." },
  { question: "A investigação SIPAER trabalha com prazos fixos para sua conclusão?", options: ["Sim, o Relatório Final deve sair em 12 meses.", "Sim, 90 dias para Incidentes e 180 dias for Acidentes.", "Não, o processo segue a seu tempo e é proporcional à complexidade do acidente.", "Sim, 30 dias para o Reporte Preliminar."], answer: "Não, o processo segue a seu tempo e é proporcional à complexidade do acidente." },
  { question: "De acordo com o Art. 88-O da Lei nº 7.565 (CBA), quem deve isolar e preservar o local do acidente?", options: ["O operador da aeronave.", "A autoridade policial competente.", "O Investigador-Encarregado do CENIPA.", "A equipe do SALVAERO."], answer: "A autoridade policial competente." },
  { question: "A Ação Inicial de acidentes com aeronaves RBAC 121 (transporte aéreo) é de responsabilidade de quem?", options: ["Do SERIPA da região.", "Do Elo-SIPAER do operador.", "Do CENIPA.", "Da ANAC."], answer: "Do CENIPA." },
  { question: "A Ação Inicial de acidentes com aeronaves de aviação geral (ex: táxi-aéreo, instrução) é de responsabilidade de quem?", options: ["Do CENIPA.", "Do SERIPA correspondente à região da ocorrência.", "Do operador da aeronave.", "Da ANAC."], answer: "Do SERIPA correspondente à região da ocorrência." },
  { question: "Após a liberação pelos investigadores, de quem é a responsabilidade pela remoção dos bens/destroços e higienização do local?", options: ["Do CENIPA.", "Da autoridade policial.", "Da administração do aeroporto, em todos os casos.", "Do operador ou proprietário da aeronave."], answer: "Do operador ou proprietário da aeronave." },
  { question: "O que é o 'RELPREV' (Relato de Prevenção)?", options: ["Um documento de punição interna da empresa.", "O relatório preliminar enviado à OACI.", "Um documento formal para o reporte voluntário de uma situação potencial de risco.", "A notificação obrigatória de um acidente."], answer: "Um documento formal para o reporte voluntário de uma situação potencial de risco." },
  { question: "O que é o 'Reporte Preliminar (RP)'?", options: ["O mesmo que o Relatório Final.", "Comunicação para divulgação imediata dos dados obtidos nos estágios iniciais da investigação.", "O relatório voluntário (RELPREV).", "Um documento que aponta os culpados preliminarmente."], answer: "Comunicação para divulgação imediata dos dados obtidos nos estágios iniciais da investigação." },
  { question: "O que é uma 'DIVOP' (Divulgação Operacional)?", options: ["Uma ferramenta de comunicação de assunto de interesse da prevenção, visando a segurança.", "A ordem de serviço para a equipe de manutenção.", "O comunicado oficial de imprensa sobre o acidente.", "A escala de voo dos tripulantes."], answer: "Uma ferramenta de comunicação de assunto de interesse da prevenção, visando a segurança." },
  { question: "O uso do Relatório Final para fins que não sejam de prevenção (ex: processos judiciais) é recomendado?", options: ["Sim, ele é a prova principal.", "Não, pois poderá induzir a interpretações e conclusões errôneas.", "Sim, é sua finalidade secundária.", "Apenas se o juiz autorizar."], answer: "Não, pois poderá induzir a interpretações e conclusões errôneas." },
  { question: "A quem o CENIPA encaminhará uma Recomendação de Segurança afeta aos Provedores de Serviço de Navegação Aérea (PSNA)?", options: ["À ANAC.", "Ao DECEA.", "À OACI.", "Ao SERIPA da região."], answer: "Ao DECEA." },
  { question: "O que é o 'PEAA' (Plano de Emergência Aeronáutica em Aeródromo)?", options: ["O plano de voo de uma aeronave em emergência.", "A investigação de um acidente no aeródromo.", "Documento que estabelece procedimentos e responsabilidades para o atendimento a uma emergência aeronáutica no aeródromo.", "O plano de evacuação de um terminal de passageiros."], answer: "Documento que estabelece procedimentos e responsabilidades para o atendimento a uma emergência aeronáutica no aeródromo." },
  { question: "O que é o 'PPAA' (Programa de Prevenção de Acidentes Aeronáuticos)?", options: ["O mesmo que o SGSO (SMS).", "Um documento que estabelece a política de segurança operacional e ações/responsabilidades sob a ótica do SIPAER.", "O conjunto de leis do Código Brasileiro de Aeronáutica.", "O treinamento anual obrigatório dos pilotos."], answer: "Um documento que estabelece a política de segurança operacional e ações/responsabilidades sob a ótica do SIPAER." }
];

const quizDataSistAvCivilN1 = [
  { question: "Qual foi a principal convenção que estabeleceu o novo ordenamento jurídico para a aviação civil internacional e criou a OACI?", options: ["Convenção de Paris (1919)", "Convenção de Varsóvia (1929)", "Convenção de Chicago (1944)", "Convenção de Montreal (1999)"], answer: "Convenção de Chicago (1944)" },
  { question: "Qual convenção de 1919 consagrou a teoria da soberania do Estado sobre o espaço aéreo, de corrente inglesa, e criou a CINA (embrião da OACI)?", options: ["Convenção de Havana", "Convenção de Roma", "Convenção de Paris", "Convenção de Bruxelas"], answer: "Convenção de Paris" },
  { question: "A Convenção de Varsóvia (1929) teve como principal objetivo regular o quê?", options: ["As regras de tráfego aéreo e auxílios à navegação.", "As condições do transporte aéreo internacional, a responsabilidade do transportador e os documentos (bilhete, nota de bagagem).", "Os danos causados a terceiros na superfície.", "A criação de aeroportos internacionais."], answer: "As condições do transporte aéreo internacional, a responsabilidade do transportador e os documentos (bilhete, nota de bagagem)." },
  { question: "Qual é o poder máximo da OACI, constituído por todos os Estados contratantes (193), que se reúnem a cada três anos?", options: ["O Conselho", "O Secretariado", "A Assembleia", "A Comissão de Navegação Aérea"], answer: "A Assembleia" },
  { question: "O Conselho da OACI, órgão permanente que dirige a organização, é composto por quantos Estados-membros?", options: ["193", "54", "36", "26"], answer: "36" },
  { question: "Qual é a sede permanente da Organização de Aviação Civil Internacional (OACI)?", options: ["Chicago, EUA", "Montreal, Canadá", "Paris, França", "Genebra, Suíça"], answer: "Montreal, Canadá" },
  { question: "O que um Estado contratante da OACI deve fazer se considerar impraticável cumprir um padrão internacional, conforme o Artigo 38?", options: ["Solicitar uma votação na Assembleia.", "Ignorar o padrão, pois é apenas uma recomendação.", "Informar imediatamente à OACI as 'DIFERENÇAS' entre suas práticas e o padrão.", "Pagar uma multa ao Comitê de Finanças."], answer: "Informar imediatamente à OACI as 'DIFERENÇAS' entre suas práticas e o padrão." },
  { question: "Qual é a definição da 1ª Liberdade do Ar?", options: ["Direito de realizar pouso técnico.", "Direito de sobrevoar o território de outro país sem pousar.", "Direito de desembarcar passageiros vindos do país de origem.", "Direito de embarcar passageiros para qualquer destino."], answer: "Direito de sobrevoar o território de outro país sem pousar." },
  { question: "Qual é a definição da 2ª Liberdade do Ar?", options: ["Direito de sobrevoar o território.", "Direito de embarcar passageiros no país B destinados ao país C.", "Direito de realizar pouso técnico (não comercial) em outro país.", "Direito de embarcar passageiros destinados ao país de origem da aeronave."], answer: "Direito de realizar pouso técnico (não comercial) em outro país." },
  { question: "Um voo de uma empresa brasileira (País A) que embarca passageiros no Brasil e os desembarca em Buenos Aires (País B) está exercendo qual liberdade do ar?", options: ["1ª Liberdade", "2ª Liberdade", "3ª Liberdade", "4ª Liberdade"], answer: "3ª Liberdade" },
  { question: "Um voo de uma empresa brasileira (País A) que embarca passageiros em Buenos Aires (País B) destinados ao Brasil (País A) está exercendo qual liberdade do ar?", options: ["2ª Liberdade", "3ª Liberdade", "4ª Liberdade", "5ª Liberdade"], answer: "4ª Liberdade" },
  { question: "Um voo de uma empresa brasileira (País A) na rota Brasil -> Madrid (País B) -> Roma (País C), que embarca passageiros em Madrid e os desembarca em Roma, exerce qual liberdade?", options: ["3ª Liberdade", "4ª Liberdade", "5ª Liberdade", "7ª Liberdade"], answer: "5ª Liberdade" },
  { question: "Qual Anexo da OACI trata de 'Licenças de pessoal' (pilotos, controladores, mecânicos)?", options: ["Anexo 1", "Anexo 6", "Anexo 10", "Anexo 14"], answer: "Anexo 1" },
  { question: "Qual Anexo da OACI trata de 'Investigação de acidentes de aeronaves'?", options: ["Anexo 19", "Anexo 17", "Anexo 13", "Anexo 12"], answer: "Anexo 13" },
  { question: "Qual Anexo da OACI trata de 'Segurança' (Security - proteção contra atos de interferência ilícita)?", options: ["Anexo 19", "Anexo 17", "Anexo 13", "Anexo 9"], answer: "Anexo 17" },
  { question: "Qual Anexo da OACI trata de 'Gestão de segurança operacional' (Safety - SMS/SGSO)?", options: ["Anexo 19", "Anexo 17", "Anexo 13", "Anexo 1"], answer: "Anexo 19" },
  { question: "Qual Anexo da OACI trata de 'Aeródromos' (características físicas, equipamentos)?", options: ["Anexo 11", "Anexo 10", "Anexo 15", "Anexo 14"], answer: "Anexo 14" },
  { question: "Qual a principal diferença entre a OACI e a IATA?", options: ["A OACI cuida da segurança e a IATA das tarifas.", "A OACI é uma agência da ONU (pública/governamental) e a IATA é uma associação de empresas (privada).", "A OACI tem sede em Montreal e a IATA em Chicago.", "A OACI emite os Anexos e a IATA as Liberdades do Ar."], answer: "A OACI é uma agência da ONU (pública/governamental) e a IATA é uma associação de empresas (privada)." },
  { question: "No Brasil, qual órgão é a agência reguladora responsável por regular e fiscalizar as atividades da aviação civil e a infraestrutura aeronáutica?", options: ["Ministério dos Portos e Aeroportos", "Comando da Aeronáutica (COMAER)", "Agência Nacional de Aviação Civil (ANAC)", "Departamento de Controle do Espaço Aérea (DECEA)"], answer: "Agência Nacional de Aviação Civil (ANAC)" },
  { question: "A ANAC é uma autarquia de regime especial vinculada a qual ministério?", options: ["Ministério da Defesa", "Ministério da Justiça", "Ministério dos Portos e Aeroportos", "Ministério da Ciência e Tecnologia"], answer: "Ministério dos Portos e Aeroportos" },
  { question: "Qual órgão a ANAC substituiu em 2006?", options: ["O CENIPA", "O Departamento de Aviação Civil (DAC)", "O DCTA", "A INFRAERO"], answer: "O Departamento de Aviação Civil (DAC)" },
  { question: "No Sistema de Aviação Civil Nacional, qual órgão é responsável pelo Controle do Espaço Aéreo?", options: ["ANAC", "CENIPA", "DECEA", "DCTA"], answer: "DECEA" },
  { question: "Qual órgão do COMAER tem a finalidade de investigar e prevenir acidentes aeronáuticos?", options: ["ANAC", "CENIPA", "DECEA", "DCTA"], answer: "CENIPA" },
  { question: "Qual é a atividade que NÃO está no campo de atuação da ANAC?", options: ["Administrar o Registro Aeronáutico Brasileiro (RAB).", "Certificar licenças e habilitações dos profissionais de aviação civil.", "Investigação de acidentes aeronáuticos e controle do espaço aéreo.", "Conceder autorização para exploração de serviços aéreos."], answer: "Investigação de acidentes aeronáuticos e controle do espaço aéreo." },
  { question: "Qual organização do COMAER é encarregada da construção de aeroportos na Região Amazônica, visando a integração nacional?", options: ["INFRAERO", "EMBRAER", "COMARA", "DCTA"], answer: "COMARA" },
  { question: "Qual é o órgão dentro do COMAER responsável pelo Sistema de Controle do Espaço Aéreo Brasileiro (SISCEAB)?", options: ["CENIPA", "ANAC", "DECEA", "DCTA"], answer: "DECEA" },
  { question: "Qual é a finalidade dos CINDACTA (Centros Integrados de Defesa Aérea e Controle de Tráfego Aéreo)?", options: ["Apenas investigar acidentes aeronáuticos.", "Apenas homologar aeronaves e emitir C.A.", "Desempenhar o controle do espaço aéreo e a defesa aérea do território.", "Formar pilotos e comissários."], answer: "Desempenhar o controle do espaço aéreo e a defesa aérea do território." },
  { question: "Qual órgão é subordinado ao DECEA e tem como objetivo a formação e aperfeiçoamento de pessoal técnico para a área de proteção ao voo?", options: ["DCTA (Departamento de Ciência e Tecnologia Aeroespacial)", "ITA (Instituto Tecnológico de Aeronáutica)", "ICEA (Instituto de Controle do Espaço Aéreo)", "ANAC"], answer: "ICEA (Instituto de Controle do Espaço Aéreo)" },
  { question: "Qual órgão do COMAER é responsável pela homologação de equipamentos aeronáuticos e pela formação de engenheiros através do ITA?", options: ["DECEA", "CENIPA", "COMARA", "DCTA (Departamento de Ciência e Tecnologia Aeroespacial)"], answer: "DCTA (Departamento de Ciência e Tecnologia Aeroespacial)" },
  { question: "O que é uma 'EPTA' (Estação Prestadora de Serviço de Telecomunicações e de Tráfego Aéreo)?", options: ["Um órgão público do DECEA que opera torres de controle.", "Uma autorizada (pública ou privada) que presta serviços de APP e/ou TWR em complemento à infraestrutura da União.", "O mesmo que um CINDACTA.", "Qualquer aeródromo privado."], answer: "Uma autorizada (pública ou privada) que presta serviços de APP e/ou TWR em complemento à infraestrutura da União." },
  { question: "Qual organização é uma entidade privada, fundada em Havana (1945), que atua como um 'clube' das empresas aéreas para cooperação e padronização de tarifas?", options: ["OACI", "IATA", "CLAC", "ALTA"], answer: "IATA" },
  { question: "Qual é o organismo público de aviação civil para a América Latina e Caribe, de caráter consultivo, que tem sede em Lima, Peru?", options: ["ALTA", "IATA", "CLAC", "OACI (Escritório Regional)"], answer: "CLAC" },
  { question: "Qual é a entidade privada, análoga à IATA, que foca nos interesses das empresas de transporte aéreo latino-americanas?", options: ["CLAC", "OACI", "ALTA", "CERNAI"], answer: "ALTA" },
  { question: "No Brasil, qual superintendência da ANAC é responsável pela administração do Registro Aeronáutico Brasileiro (RAB)?", options: ["SPO (Superintendência de Padrões Operacionais)", "SAR (Superintendência de Aeronavegabilidade)", "SAS (Superintendência de Acompanhamento de Serviços Aéreos)", "SPL (Superintendência de Pessoal da Aviação Civil)"], answer: "SAR (Superintendência de Aeronavegabilidade)" },
  { question: "Qual superintendência da ANAC é responsável por regular e certificar licenças e habilitações de pilotos, comissários, mecânicos e escolas (CIAC)?", options: ["SPO (Superintendência de Padrões Operacionais)", "SAR (Superintendência de Aeronavegabilidade)", "SPL (Superintendência de Pessoal da Aviação Civil)", "SFI (Superintendência de Ação Fiscal)"], answer: "SPL (Superintendência de Pessoal da Aviação Civil)" },
  { question: "A certificação de projeto de aeronaves, de organizações de produção (fábricas) e de organizações de manutenção (oficinas) compete a qual superintendência da ANAC?", options: ["SPO (Superintendência de Padrões Operacionais)", "SAR (Superintendência de Aeronavegabilidade)", "SPL (Superintendência de Pessoal da Aviação Civil)", "SIA (Superintendência de Infraestrutura Aeroportuária)"], answer: "SAR (Superintendência de Aeronavegabilidade)" },
  { question: "A regulamentação das operações de empresas aéreas (RBAC 121, 135) e a certificação de oficinas de manutenção são foco de qual superintendência da ANAC?", options: ["SPO (Superintendência de Padrões Operacionais)", "SAR (Superintendência de Aeronavegabilidade)", "SAS (Superintendência de Acompanhamento de Serviços Aéreos)", "SPL (Superintendência de Pessoal da Aviação Civil)"], answer: "SPO (Superintendência de Padrões Operacionais)" },
  { question: "Qual superintendência da ANAC é responsável pela outorga (concessão) para exploração de serviços aéreos públicos e pelos direitos dos usuários?", options: ["SPO (Superintendência de Padrões Operacionais)", "SRA (Superintendência de Regulação Econômica)", "SAS (Superintendência de Acompanhamento de Serviços Aéreos)", "SFI (Superintendência de Ação Fiscal)"], answer: "SAS (Superintendência de Acompanhamento de Serviços Aéreos)" },
  { question: "Qual superintendência da ANAC fiscaliza o cumprimento dos contratos de transporte (direitos dos usuários) e coordena o plano de assistência a vítimas em caso de acidente?", options: ["ASSOP", "SFI (Superintendência de Inteligência e Ação Fiscal)", "SAS (Superintendência de Acompanhamento de Serviços Aéreos)", "SPL (Superintendência de Pessoal da Aviação Civil)"], answer: "SFI (Superintendência de Inteligência e Ação Fiscal)" },
  { question: "Qual assessoria da ANAC é responsável por representar o Brasil em acordos internacionais e coordenar assuntos de meio ambiente?", options: ["ASSOP (Assessoria de Segurança Operacional)", "ASINT (Assessoria de Relações Internacionais)", "CERNAI", "SGM (Superintendência de Governança e Meio Ambiente)"], answer: "ASINT (Assessoria de Relações Internacionais)" },
  { question: "O que é um 'INSPAC'?", options: ["Um investigador de acidentes do CENIPA.", "Um controlador de voo do DECEA.", "Um funcionário da ANAC (civil ou militar) credenciado para fiscalizar empresas, seja em rampa, a bordo ou em terra.", "Um engenheiro do DCTA."], answer: "Um funcionário da ANAC (civil ou militar) credenciado para fiscalizar empresas, seja em rampa, a bordo ou em terra." },
  { question: "Onde a ANAC atua diretamente nos aeroportos para fiscalização de rampa, aeronavegabilidade e atendimento ao público?", options: ["Nos SERIPA", "Nos CINDACTA", "Nos Núcleos Regionais de Aviação Civil (NURAC)", "Nos DTCEA"], answer: "Nos Núcleos Regionais de Aviação Civil (NURAC)" },
  { question: "Qual o código utilizado pela OACI (ICAO) para designar aeroportos (ex: SBGR)?", options: ["Duas letras", "Três letras", "Quatro letras", "Três números"], answer: "Quatro letras" },
  { question: "Qual o código utilizado pela OACI (ICAO) para designar companhias aéreas (ex: TAM)?", options: ["Duas letras", "Três letras", "Quatro letras", "Duas letras e um número"], answer: "Três letras" },
  { question: "O que é a 'GTRAB' (Gerência Técnica do Registro Aeronáutico)?", options: ["O órgão da ANAC que administra o RAB, emite Certificados de Matrícula (C.M.) e Aeronavegabilidade (C.A.).", "O órgão do DECEA que gerencia o tráfego aéreo.", "O órgão do CENIPA que registra os acidentes.", "A gerência da INFRAERO que cuida das taxas."], answer: "O órgão da ANAC que administra o RAB, emite Certificados de Matrícula (C.M.) e Aeronavegabilidade (C.A.)." },
  { question: "De acordo com o RBAC 141, como é classificado um 'CIAC Tipo 1'?", options: ["Desenvolve instrução prática em voo.", "Desenvolve instrução teórica e prática (exceto voo) e instrução teórica para todos os cursos.", "Desenvolve instrução teórica e prática em voo.", "Desenvolve apenas instrução em simuladores."], answer: "Desenvolve instrução teórica e prática (exceto voo) e instrução teórica para todos os cursos." },
  { question: "De acordo com o RBAC 141, como é classificado um 'CIAC Tipo 2'?", options: ["Desenvolve exclusivamente instrução prática em voo.", "Desenvolve apenas instrução teórica.", "Desenvolve instrução teórica e prática em simulador.", "Desenvolve instrução teórica e prática em voo."], answer: "Desenvolve exclusivamente instrução prática em voo." },
  { question: "Qual é a filosofia da ANAC em relação à regulamentação das atividades aerodesportivas?", options: ["Proibição total em espaço aéreo controlado.", "Regulamentação máxima, exigindo os mesmos padrões da aviação comercial.", "Filosofia do voo por conta e risco, focando na segurança de terceiros e do sistema.", "Subordinação total ao DECEA."], answer: "Filosofia do voo por conta e risco, focando na segurança de terceiros e do sistema." },
  { question: "Qual organização internacional é uma agência especializada da ONU e mantém relações com a OMM (Meteorologia) e a OIT (Trabalho)?", options: ["IATA", "OACI", "CLAC", "ALTA"], answer: "OACI" },
  { question: "Qual é o nome do escritório regional da OACI que cobre a América do Sul, localizado em Lima, Peru?", options: ["Sede da OACI", "Escritório Regional da América do Sul", "Sede da CLAC", "Sede da IATA"], answer: "Escritório Regional da América do Sul" }
];

const quizDataSistAvCivilN2 = [
  { question: "Qual Convenção, realizada em 1929, unificou as regras sobre documentos de transporte (bilhete, nota de bagagem) e a responsabilidade do transportador?", options: ["Convenção de Paris (1919)", "Convenção de Chicago (1944)", "Convenção de Varsóvia (1929)", "Convenção de Montreal (1999)"], answer: "Convenção de Varsóvia (1929)" },
  { question: "A Convenção de Roma (1933) tratou de dois temas principais. Quais foram eles?", options: ["Danos a terceiros na superfície e sequestro preventivo de aeronaves.", "Criação da OACI e direitos de sobrevoo.", "Padronização de cartas aeronáuticas e meteorologia.", "Tarifas de transporte e direitos dos passageiros."], answer: "Danos a terceiros na superfície e sequestro preventivo de aeronaves." },
  { question: "Na Convenção de Chicago (1944), o 'Acordo de Trânsito' consagrou quais liberdades do ar?", options: ["As três últimas (3ª, 4ª e 5ª)", "Apenas a 1ª", "A 1ª e a 2ª", "A 3ª e a 4ª"], answer: "A 1ª e a 2ª" },
  { question: "O Brasil assinou o 'Acordo de Transporte' (que consagra a 3ª, 4ª e 5ª liberdades) proposto na Convenção de Chicago?", options: ["Sim, e foi um dos primeiros a ratificar.", "Não, o Brasil não assinou o Acordo de Transporte.", "Sim, mas apenas em caráter provisório.", "Não, o Brasil assinou apenas o Acordo de Transporte e não o de Trânsito."], answer: "Não, o Brasil não assinou o Acordo de Transporte." },
  { question: "Como são classificadas a 3ª e a 4ª Liberdades do Ar, que constituem o principal objetivo do relacionamento aeronáutico entre dois países?", options: ["Acessórias", "Comerciais Suplementares", "Fundamentais", "Técnicas"], answer: "Fundamentais" },
  { question: "Uma empresa brasileira que transporta passageiros entre Paris (País B) e Londres (País C), com pouso intermediário no Brasil (País A), está exercendo qual liberdade?", options: ["5ª Liberdade", "6ª Liberdade", "7ª Liberdade", "8ª Liberdade"], answer: "6ª Liberdade" },
  { question: "Uma empresa brasileira (País A) que opera uma rota entre dois países estrangeiros (País B -> País C) sem passar pelo Brasil, está exercendo qual liberdade?", options: ["5ª Liberdade", "6ª Liberdade", "7ª Liberdade", "Cabotagem (9ª)"], answer: "7ª Liberdade" },
  { question: "Como é definida a 8ª Liberdade do Ar (Cabotagem Consecutiva)?", options: ["Transportar tráfego entre dois outros países com pouso no país de origem.", "Transportar tráfego inteiramente dentro de um terceiro Estado.", "Transportar tráfego entre dois pontos do território de um Estado diferente do da bandeira da aeronave (Ex: Voo GIG-MIA-JFK, pegando passageiro em MIA para JFK).", "Direito de sobrevoo simples."], answer: "Transportar tráfego entre dois pontos do território de um Estado diferente do da bandeira da aeronave (Ex: Voo GIG-MIA-JFK, pegando passageiro em MIA para JFK)." },
  { question: "Os 36 membros do Conselho da OACI são eleitos pela Assembleia em três partes. A 'Parte I' representa quais Estados?", options: ["Estados com relevante representação geográfica.", "Estados que mais contribuem com instalações de navegação aérea.", "Estados de maior importância no transporte aéreo.", "Estados fundadores da OACI."], answer: "Estados de maior importância no transporte aéreo." },
  { question: "Qual órgão técnico da OACI é encarregado dos estudos para padrões de aeródromos, telecomunicações, meteorologia e tráfego aéreo?", options: ["Comitê de Transporte Aéreo", "Comissão de Navegação Aérea", "Comitê Jurídico", "Comitê sobre Interferência Ilícita"], answer: "Comissão de Navegação Aérea" },
  { question: "Qual é a principal diferença de status entre os 'Anexos' da OACI e os 'PANS' (Procedimentos para o Serviço de Navegação Aérea)?", options: ["Os Anexos são obrigatórios e os PANS são opcionais.", "Os PANS não têm a mesma rigidez de adoção dos Anexos, sendo considerados 'Recomendações'.", "Os Anexos são para pilotos e os PANS para controladores.", "Não há diferença, ambos são padrões mandatórios."], answer: "Os PANS não têm a mesma rigidez de adoção dos Anexos, sendo considerados 'Recomendações'." },
  { question: "Qual é o padrão de código da OACI (ICAO) para designar companhias aéreas e aeroportos, respectivamente?", options: ["2 letras para Cia / 3 letras para Aeroporto", "3 letras para Cia / 4 letras para Aeroporto", "3 letras para Cia / 3 letras para Aeroporto", "4 letras para Cia / 4 letras para Aeroporto"], answer: "3 letras para Cia / 4 letras para Aeroporto" },
  { question: "Qual o nome do órgão de assessoramento do COMAER que substituiu as funções da antiga CERNAI, tratando de assuntos do transporte aéreo internacional?", options: ["OACI-BR", "ANAC", "ASINT (Assessoria Internacional)", "CLAC"], answer: "ASINT (Assessoria Internacional)" },
  { question: "No Sistema de Aviação Civil Nacional, a GTRAB (Gerência Técnica do Registro Aeronáutico) está subordinada a qual Superintendência da ANAC?", options: ["Superintendência de Padrões Operacionais (SPO)", "Superintendência de Aeronavegabilidade (SAR)", "Superintendência de Pessoal da Aviação Civil (SPL)", "Superintendência de Administração e Finanças (SAF)"], answer: "Superintendência de Aeronavegabilidade (SAR)" },
  { question: "Qual é a função da GTRAB, além de efetuar o registro de aeronaves?", options: ["Investigar acidentes.", "Emitir Certificados de Matrícula (C.M.) e de Aeronavegabilidade (C.A.).", "Controlar o tráfego aéreo.", "Aplicar sanções a companhias aéreas."], answer: "Emitir Certificados de Matrícula (C.M.) e de Aeronavegabilidade (C.A.)." },
  { question: "Qual é a principal função do DCTA (Departamento de Ciência e Tecnologia Aeroespacial) no Sistema de Aviação Civil?", options: ["Controlar o espaço aéreo de São Paulo.", "Investigar acidentes aeronáuticos.", "Homologar equipamentos aeronáuticos e formar engenheiros (via ITA).", "Construir aeroportos na Amazônia."], answer: "Homologar equipamentos aeronáuticos e formar engenheiros (via ITA)." },
  { question: "Qual órgão do COMAER é destinado à formação de técnicos e engenheiros de altíssimo nível, como o ITA?", options: ["ICEA", "CENIPA", "DCTA", "COMARA"], answer: "DCTA" },
  { question: "Qual é a função do ICEA (Instituto de Controle do Espaço Aéreo)?", options: ["Formar engenheiros aeronáuticos (ITA).", "Formar e aperfeiçoar pessoal técnico (recursos humanos) voltado para a área de proteção ao voo.", "Projetar aeronaves para a FAB.", "Investigar acidentes."], answer: "Formar e aperfeiçoar pessoal técnico (recursos humanos) voltado para a área de proteção ao voo." },
  { question: "O que é o 'SICONFAC'?", options: ["O sistema de arrecadação de tarifas.", "O sistema de controle de tráfego aéreo.", "Um sistema integrado para controle e fiscalização, que cadastra horas voadas, tripulantes e aeronaves.", "O sistema de investigação de acidentes."], answer: "Um sistema integrado para controle e fiscalização, que cadastra horas voadas, tripulantes e aeronaves." },
  { question: "Qual é a finalidade do 'SUCOTAP'?", options: ["O processamento, a arrecadação e a cobrança de tarifas aeroportuárias e de navegação aérea.", "A homologação de peças de aeronaves.", "O registro de aeronaves civis (RAB).", "O controle de jornada de tripulantes."], answer: "O processamento, a arrecadação e a cobrança de tarifas aeroportuárias e de navegação aérea." },
  { question: "Qual é a empresa pública federal destinada a implementar, operar e administrar a infraestrutura aeroportuária?", options: ["ANAC", "DECEA", "INFRAERO", "EMBRAER"], answer: "INFRAERO" },
  { question: "Quem preside o CONAC (Conselho de Aviação Civil), órgão que estabelece as diretrizes da política do setor?", options: ["O Presidente da ANAC", "O Comandante da Aeronáutica", "O Ministro de Portos e Aeroportos", "O Presidente da República"], answer: "O Ministro de Portos e Aeroportos" },
  { question: "De acordo com o CBA (Arts. 102-104), o que são 'Serviços Auxiliares ao Transporte Aéreo'?", options: ["O serviço de tráfego aéreo e meteorologia.", "Apenas a venda de passagens e cargas.", "Agências de carga aérea, serviços de rampa (ground handling) e hotelaria nos aeroportos.", "A investigação de incidentes de solo."], answer: "Agências de carga aérea, serviços de rampa (ground handling) e hotelaria nos aeroportos." },
  { question: "Qual superintendência da ANAC é focada nos operadores aéreos (empresas) e na certificação de oficinas de manutenção?", options: ["Superintendência de Padrões Operacionais (SPO)", "Superintendência de Aeronavegabilidade (SAR)", "Superintendência de Pessoal da Aviação Civil (SPL)", "Superintendência de Infraestrutura Aeroportuária (SIA)"], answer: "Superintendência de Padrões Operacionais (SPO)" },
  { question: "Qual superintendência da ANAC cuida da regulação das organizações de instrução (CIAC) e da certificação de proficiência linguística de pilotos?", options: ["Superintendência de Padrões Operacionais (SPO)", "Superintendência de Aeronavegabilidade (SAR)", "Superintendência de Pessoal da Aviação Civil (SPL)", "Superintendência de Ação Fiscal (SFI)"], answer: "Superintendência de Pessoal da Aviação Civil (SPL)" },
  { question: "Qual superintendência da ANAC é responsável por regular a operação de infraestrutura aeroportuária e os serviços conexos, como o SESCINC (Bombeiros de Aeródromo)?", options: ["SPO (Superintendência de Padrões Operacionais)", "SAR (Superintendência de Aeronavegabilidade)", "SIA (Superintendência de Infraestrutura Aeroportuária)", "SRA (Superintendência de Regulação Econômica de Aeroportos)"], answer: "SIA (Superintendência de Infraestrutura Aeroportuária)" },
  { question: "Qual superintendência da ANAC é responsável pela proposta de outorga (concessão) para exploração de aeródromos civis públicos?", options: ["SIA (Superintendência de Infraestrutura Aeroportuária)", "SRA (Superintendência de Regulação Econômica de Aeroportos)", "SAS (Superintendência de Acompanhamento de Serviços Aéreos)", "SAF (Superintendência de Administração e Finanças)"], answer: "SRA (Superintendência de Regulação Econômica de Aeroportos)" },
  { question: "A 'regulação técnica' da ANAC busca garantir o quê?", options: ["A máxima eficiência do mercado e tarifas justas.", "A garantia da segurança aos usuários, por meio de certificação e fiscalização.", "A arrecadação de tarifas aeroportuárias.", "A punição de crimes aeronáuticos."], answer: "A garantia da segurança aos usuários, por meio de certificação e fiscalização." },
  { question: "A 'regulação econômica' da ANAC refere-se a quê?", options: ["Ao monitoramento e intervenções no mercado para buscar a máxima eficiência.", "À certificação de aeronaves e pessoal.", "À investigação de acidentes.", "À definição de regras de tráfego aéreo."], answer: "Ao monitoramento e intervenções no mercado para buscar a máxima eficiência." },
  { question: "O que é o CRCEA-SE (Centro Regional de Controle do Espaço Aéreo Sudeste)?", options: ["É o mesmo que o CINDACTA de São Paulo.", "Um órgão regional do DECEA que trata de assuntos de controle do espaço aéreo em sua jurisdição (ex: autorizar voos de acrobacia).", "Um órgão da ANAC para fiscalização em São Paulo.", "A sede da INFRAERO no Sudeste."], answer: "Um órgão regional do DECEA que trata de assuntos de controle do espaço aéreo em sua jurisdição (ex: autorizar voos de acrobacia)." },
  { question: "O que é um DTCEA (Destacamento de Controle do Espaço Aéreo)?", options: ["Um órgão de investigação de acidentes, subordinado ao SERIPA.", "O órgão local de proteção ao voo (torre, controle) situado nos aeródromos controlados pelo COMAER.", "Uma escola de formação de controladores de voo.", "Um escritório regional da ANAC."], answer: "O órgão local de proteção ao voo (torre, controle) situado nos aeródromos controlados pelo COMAER." },
  { question: "Os SERIPA (Serviços Regionais de Investigação) são subordinados técnica e operacionalmente a quem?", options: ["Ao CINDACTA de sua região.", "Ao DECEA.", "Ao CENIPA.", "À ANAC."], answer: "Ao CENIPA." },
  { question: "Qual a principal diferença entre os códigos de aeroporto da IATA e da ICAO?", options: ["IATA usa 3 letras (ex: GIG) e ICAO usa 4 letras (ex: SBGL).", "IATA usa 4 letras (ex: SBGL) e ICAO usa 3 letras (ex: GIG).", "Ambas usam 3 letras, mas com padrões diferentes.", "IATA usa códigos para aeroportos e ICAO para companhias."], answer: "IATA usa 3 letras (ex: GIG) e ICAO usa 4 letras (ex: SBGL)." },
  { question: "A IATA (Associação Internacional de Transporte Aéreo) é uma entidade de qual natureza?", options: ["Pública, subordinada à OACI.", "Privada, uma associação de empresas aéreas.", "Governamental, ligada à ONU.", "Regional, focada apenas na Europa."], answer: "Privada, uma associação de empresas aéreas." },
  { question: "A CLAC (Comissão Latino-Americana de Aviação Civil) é uma entidade de qual natureza?", options: ["Privada, uma associação de empresas (como a ALTA).", "Pública, um organismo de caráter consultivo entre governos.", "Pública, subordinada diretamente à OACI.", "Privada, focada em segurança de voo."], answer: "Pública, um organismo de caráter consultivo entre governos." },
  { question: "O que é a 'derregulation' (desregulamentação), citada como um problema em acordos aéreos?", options: ["A política de céus abertos que aumenta a competição, idealizada pelo governo americano.", "A exigência de tarifas fixas pela IATA.", "A proibição de voos de 5ª liberdade.", "A padronização de regras de segurança da OACI."], answer: "A política de céus abertos que aumenta a competição, idealizada pelo governo americano." },
  { question: "No Sistema de Aviação Civil, qual é a função das empresas de 'serviços aéreos especializados'?", options: ["Transporte aéreo regular de passageiros (RBAC 121).", "Atender necessidades como agroindústria, prospecção mineral, aviação executiva e táxi-aéreo.", "Construção de aeronaves (EMBRAER).", "Manutenção e reparo de aeronaves em oficinas."], answer: "Atender necessidades como agroindústria, prospecção mineral, aviação executiva e táxi-aéreo." },
  { question: "A ANAC possui autonomia administrativa e financeira, e seus dirigentes têm mandato fixo. Como essa estrutura é classificada?", options: ["Empresa Pública (ex: INFRAERO)", "Autarquia Federal de Regime Especial", "Organização Militar (ex: DECEA)", "Secretaria de Ministério"], answer: "Autarquia Federal de Regime Especial" },
  { question: "Qual Anexo da OACI trata de 'Facilitação' (simplificação de formalidades imigratórias e alfandegárias)?", options: ["Anexo 9", "Anexo 17", "Anexo 1", "Anexo 18"], answer: "Anexo 9" },
  { question: "Qual Anexo da OACI trata de 'Transporte sem riscos de mercadorias perigosas'?", options: ["Anexo 16", "Anexo 17", "Anexo 18", "Anexo 19"], answer: "Anexo 18" },
  { question: "Qual Anexo da OACI trata de 'Regras do Ar' (VFR e IFR)?", options: ["Anexo 1", "Anexo 2", "Anexo 11", "Anexo 6"], answer: "Anexo 2" },
  { question: "Qual Anexo da OACI trata de 'Serviços de Tráfego Aéreo' (ATC, FIS, ALRS)?", options: ["Anexo 2", "Anexo 10", "Anexo 11", "Anexo 14"], answer: "Anexo 11" },
  { question: "Qual Anexo da OACI trata de 'Telecomunicações Aeronáuticas' (equipamentos, sistemas, procedimentos)?", options: ["Anexo 4", "Anexo 5", "Anexo 10", "Anexo 11"], answer: "Anexo 10" },
  { question: "Qual Anexo da OACI trata de 'Busca e Salvamento' (SAR)?", options: ["Anexo 11", "Anexo 12", "Anexo 13", "Anexo 15"], answer: "Anexo 12" },
  { question: "Qual Anexo da OACI trata de 'Serviço de Informação Aeronáutica' (AIS)?", options: ["Anexo 12", "Anexo 14", "Anexo 15", "Anexo 16"], answer: "Anexo 15" },
  { question: "Qual órgão é um fórum consultivo coordenado pelo Ministério dos Portos e Aeroportos para supervisionar decisões das autoridades aeroportuárias?", options: ["CONAC (Conselho de Aviação Civil)", "CONAERO (Comissão Nacional de Autoridades Aeroportuárias)", "ANAC", "INFRAERO"], answer: "CONAERO (Comissão Nacional de Autoridades Aeroportuárias)" },
  { question: "O DECEA está subordinado a qual órgão?", options: ["Ministério da Defesa (MD)", "Comando da Aeronáutica (COMAER)", "Ministério dos Portos e Aeroportos", "ANAC"], answer: "Comando da Aeronáutica (COMAER)" },
  { question: "O CENIPA está subordinado a qual órgão?", options: ["Ministério da Defesa (MD)", "Comando da Aeronáutica (COMAER)", "Ministério dos Portos e Aeroportos", "ANAC"], answer: "Comando da Aeronáutica (COMAER)" },
  { question: "Qual superintendência da ANAC é responsável por fiscalizar o cumprimento de normas do setor, inclusive quanto aos direitos dos usuários?", options: ["Superintendência de Ação Fiscal (SFI)", "Superintendência de Pessoal da Aviação Civil (SPL)", "Superintendência de Acompanhamento de Serviços Aéreos (SAS)", "Superintendência de Governança e Meio Ambiente (SGM)"], answer: "Superintendência de Ação Fiscal (SFI)" },
  { question: "Qual o nome da assessoria da ANAC responsável por tratar de questões relacionadas à segurança operacional (Safety) e pela interface com o CENIPA?", options: ["ASINT (Assessoria de Relações Internacionais)", "ASSOP (Assessoria de Segurança Operacional)", "SPO (Superintendência de Padrões Operacionais)", "SAR (Superintendência de Aeronavegabilidade)"], answer: "ASSOP (Assessoria de Segurança Operacional)" }
];

const quizDataDireitoAeronauticoN1 = [
  { question: "De acordo com o Art. 1º do CBA, o Direito Aeronáutico é regulado primariamente por quais fontes?", options: ["Apenas pelo CBA e pela legislação complementar.", "Pelos Tratados, Convenções e Atos Internacionais de que o Brasil seja parte, por este Código e pela legislação complementar.", "Apenas pelas normas da ANAC e do DECEA.", "Pelos Tratados, exceto o CBA, que é secundário."], answer: "Pelos Tratados, Convenções e Atos Internacionais de que o Brasil seja parte, por este Código e pela legislação complementar." },
  { question: "Conforme o Art. 1º, § 2º, o CBA se aplica a nacionais e estrangeiros em todo o Território Nacional e, no exterior, até onde for admitida sua:", options: ["Validade.", "Autorização.", "Extraterritorialidade.", "Vigência."], answer: "Extraterritorialidade." },
  { question: "Segundo o Art. 3º, quais aeronaves são consideradas situadas no território do Estado de sua nacionalidade, mesmo quando em alto mar?", options: ["Apenas aeronaves civis de transporte regular.", "Apenas aeronaves privadas.", "Aeronaves militares e civis de propriedade ou a serviço do Estado.", "Qualquer aeronave com matrícula brasileira."], answer: "Aeronaves militares e civis de propriedade ou a serviço do Estado." },
  { question: "De acordo com o Art. 11, qual é o alcance da soberania que o Brasil exerce sobre o espaço aéreo?", options: ["Completa e exclusiva, sobre seu território e mar territorial (12 milhas).", "Compartilhada com a OACI, sobre seu território e ZEE (200 milhas).", "Relativa, sobre seu território, mas livre sobre o mar territorial.", "Completa, apenas sobre o território continental."], answer: "Completa e exclusiva, sobre seu território e mar territorial (12 milhas)." },
  { question: "De acordo com o Art. 14, § 1º, aeronaves militares ou civis a serviço de Estado estrangeiro podem voar no espaço aéreo brasileiro?", options: ["Sim, livremente, desde que sigam as regras da OACI.", "Não, em nenhuma hipótese.", "Sim, desde que obtenham autorização prévia.", "Sim, desde que não pousem no território."], answer: "Sim, desde que obtenham autorização prévia." },
  { question: "Segundo o Art. 14, § 5º, qual tipo de aeronave está isenta das tarifas de uso das comunicações e auxílios à navegação em rota?", options: ["Aeronaves de instrução de CIACs.", "Aeronaves pertencentes aos aeroclubes.", "Aeronaves de transporte de carga.", "Aeronaves de táxi-aéreo."], answer: "Aeronaves pertencentes aos aeroclubes." },
  { question: "Conforme o Art. 16, um proprietário de solo pode se opor ao sobrevoo de uma aeronave?", options: ["Sim, se a aeronave estiver voando baixo.", "Sim, a qualquer momento, invocando o direito de propriedade.", "Não, desde que o sobrevoo se realize de acordo com as normas vigentes.", "Apenas se for uma aeronave militar estrangeira."], answer: "Não, desde que o sobrevoo se realize de acordo com as normas vigentes." },
  { question: "No caso de um pouso forçado (Art. 16, § 1º), o proprietário do solo pode impedir a retirada da aeronave?", options: ["Sim, até que a autoridade policial chegue.", "Não, desde que lhe seja dada garantia de reparação do dano.", "Sim, ele pode reter a aeronave como pagamento pelo dano.", "Não, em nenhuma hipótese."], answer: "Não, desde que lhe seja dada garantia de reparação do dano." },
  { question: "De acordo com o Art. 18, o que deve fazer o Comandante que receber uma ordem de pouso de um órgão controlador?", options: ["Questionar a ordem e seguir para seu destino original.", "Dirigir-se imediatamente ao aeródromo indicado e nele pousar.", "Pousar no aeródromo mais próximo de sua escolha.", "Comunicar seu operador antes de tomar a decisão."], answer: "Dirigir-se imediatamente ao aeródromo indicado e nele pousar." },
  { question: "Se, no Art. 18, o Comandante julgar que razões técnicas o impedem de pousar no aeródromo indicado, o que ele deve fazer?", options: ["Ignorar a ordem e seguir para a alternativa.", "Declarar emergência e pousar em qualquer local.", "Solicitar ao órgão controlador a determinação de um aeródromo alternativo seguro.", "Desligar o transponder e evadir-se."], answer: "Solicitar ao órgão controlador a determinação de um aeródromo alternativo seguro." },
  { question: "Conforme o Art. 18, § 3º, qual é a consequência para a tripulação em caso de manifesta inobservância de uma ordem de pouso?", options: ["Será aplicada apenas uma multa.", "Será autuada a tripulação e apreendida a aeronave.", "A aeronave será advertida e liberada.", "A tripulação será suspensa por 30 dias."], answer: "Será autuada a tripulação e apreendida a aeronave." },
  { question: "De acordo com o Art. 20, quais são os documentos e equipamentos mínimos exigidos para que uma aeronave possa voar no espaço aéreo brasileiro?", options: ["Apenas marcas de nacionalidade e matrícula.", "Apenas tripulação habilitada e Diário de Bordo.", "Marcas, certificados (matrícula/aeronavegabilidade), equipamentos (navegação/comunicações/salvamento) e tripulação habilitada.", "Apenas o certificado de aeronavegabilidade e um piloto licenciado."], answer: "Marcas, certificados (matrícula/aeronavegabilidade), equipamentos (navegação/comunicações/salvamento) e tripulação habilitada." },
  { question: "Segundo o Art. 21, o transporte de armas de fogo ou material bélico em aeronaves civis é:", options: ["Permitido livremente em voos de carga.", "Proibido em qualquer circunstância.", "Permitido, salvo com autorização especial de órgão competente.", "Permitido apenas para aeronaves de segurança pública, sem exceções."], answer: "Permitido, salvo com autorização especial de órgão competente." },
  { question: "Conforme o Art. 22, uma aeronave proveniente do exterior deve, via de regra, fazer seu primeiro pouso em qual tipo de aeroporto?", options: ["Em qualquer aeródromo público.", "Em qualquer aeródromo homologado pela ANAC.", "Em um aeroporto internacional.", "No aeroporto mais próximo da fronteira."], answer: "Em um aeroporto internacional." },
  { question: "O Art. 25 define a 'Infraestrutura Aeronáutica'. Qual dos seguintes sistemas NÃO faz parte desta definição?", options: ["Sistema de proteção ao voo.", "Sistema de Registro Aeronáutico Brasileiro (RAB).", "Sistema de investigação e prevenção de acidentes (SIPAER).", "Sistema de transporte rodoviário de cargas."], answer: "Sistema de transporte rodoviário de cargas." },
  { question: "Qual é a definição de 'Aeródromo' segundo o Art. 27 do CBA?", options: ["Toda área destinada a pouso, decolagem e movimentação de aeronaves.", "Apenas aeródromos públicos com instalações para passageiros.", "Toda área homologada para voos IFR.", "Apenas aeródromos militares."], answer: "Toda área destinada a pouso, decolagem e movimentação de aeronaves." },
  { question: "De acordo com o Art. 28, os aeródromos são classificados em:", options: ["Públicos e Privados.", "Internacionais e Domésticos.", "Civis e Militares.", "Controlados e Não Controlados."], answer: "Civis e Militares." },
  { question: "Conforme o Art. 29, os aeródromos civis são classificados em:", options: ["Aeroportos e Helipontos.", "Públicos e Privados.", "Nacionais e Regionais.", "Controlados e Não Controlados."], answer: "Públicos e Privados." },
  { question: "Segundo o Art. 30, § 2º, qual é a principal restrição de uso para aeródromos privados?", options: ["Só podem operar aeronaves de asa fixa.", "Só podem ser usados pelo proprietário, vedada a exploração comercial.", "Não podem ter operações IFR.", "Não podem ser usados por aeronaves estrangeiras."], answer: "Só podem ser usados pelo proprietário, vedada a exploração comercial." },
  { question: "Qual é a definição de 'Aeroporto' conforme o Art. 31?", options: ["Qualquer aeródromo privado.", "Aeródromos públicos dotados de instalações e facilidades para apoio de operações, embarque e desembarque.", "Aeródromos destinados exclusivamente a helicópteros.", "Qualquer aeródromo que possua um DTCEA."], answer: "Aeródromos públicos dotados de instalações e facilidades para apoio de operações, embarque e desembarque." },
  { question: "Qual é a definição de 'Heliponto' conforme o Art. 31?", options: ["Qualquer aeródromo público para helicópteros.", "Aeródromos destinados exclusivamente a helicópteros.", "Helipontos públicos com instalações e facilidades.", "Apenas helipontos em navios ou plataformas."], answer: "Aeródromos destinados exclusivamente a helicópteros." },
  { question: "Qual é a definição de 'Heliporto' conforme o Art. 31?", options: ["Qualquer aeródromo destinado a helicópteros.", "Helipontos privados em edifícios.", "Helipontos públicos, dotados de instalações e facilidades para apoio de operações e embarque/desembarque.", "O mesmo que Heliponto."], answer: "Helipontos públicos, dotados de instalações e facilidades para apoio de operações e embarque/desembarque." },
  { question: "O Sistema de Proteção ao Voo (Art. 47) visa à regularidade, segurança e eficiência. Qual das seguintes atividades NÃO faz parte deste sistema?", options: ["Controle de tráfego aéreo.", "Meteorologia aeronáutica.", "Busca e salvamento.", "Investigação de acidentes (SIPAER)."], answer: "Investigação de acidentes (SIPAER)." },
  { question: "De acordo com o Art. 50, o Comandante de uma aeronave tem obrigação de prestar assistência a quem se encontrar em perigo?", options: ["Não, a responsabilidade é exclusiva do SALVAERO.", "Sim, desde que possa fazê-lo sem perigo para sua aeronave, tripulação ou passageiros.", "Apenas se a pessoa em perigo estiver em outra aeronave.", "Apenas se receber uma ordem direta do DECEA."], answer: "Sim, desde que possa fazê-lo sem perigo para sua aeronave, tripulação ou passageiros." },
  { question: "O que acontece com quem provocar a movimentação desnecessária de recursos de busca e salvamento (Art. 58)?", options: ["Recebe uma advertência verbal.", "Ficará obrigado a indenizar a União pelas despesas decorrentes.", "Será preso imediatamente pela autoridade policial.", "Terá sua licença de piloto cassada."], answer: "Ficará obrigado a indenizar a União pelas despesas decorrentes." },
  { question: "Conforme o Art. 72 do CBA, o Registro Aeronáutico Brasileiro (RAB) tem como característica ser:", options: ["Público, único e centralizado.", "Público, dividido por estados (descentralizado).", "Privado e administrado pela INFRAERO.", "Militar e de acesso restrito."], answer: "Público, único e centralizado." },
  { question: "De acordo com o Art. 86-A, qual é o OBJETIVO ÚNICO da investigação de acidentes e incidentes aeronáuticos pelo SIPAER?", options: ["A determinação de culpa ou responsabilidade civil e criminal.", "A prevenção de outros acidentes e incidentes por meio da identificação de fatores contribuintes.", "O cálculo da indenização devida pelo explorador.", "A punição dos tripulantes que cometeram erros."], answer: "A prevenção de outros acidentes e incidentes por meio da identificação de fatores contribuintes." },
  { question: "Segundo o Art. 87, de quem é a responsabilidade pela prevenção de acidentes aeronáuticos?", options: ["Exclusivamente do CENIPA.", "Apenas do operador da aeronave e do Comandante.", "De todas as pessoas, naturais ou jurídicas, envolvidas com a fabricação, manutenção, operação e infraestrutura.", "Da ANAC e do DECEA, apenas."], answer: "De todas as pessoas, naturais ou jurídicas, envolvidas com a fabricação, manutenção, operação e infraestrutura." },
  { question: "Toda pessoa que tiver conhecimento de um acidente aeronáutico tem o dever (Art. 88) de comunicar o fato a quem?", options: ["À companhia de seguros.", "À autoridade pública mais próxima, pelo meio mais rápido.", "Exclusivamente ao CENIPA.", "À imprensa, para divulgação."], answer: "À autoridade pública mais próxima, pelo meio mais rápido." },
  { question: "Conforme o Art. 88-D, se no curso de uma investigação SIPAER forem encontrados indícios de crime, o que deve ser feito?", options: ["A investigação SIPAER é encerrada e vira um inquérito policial.", "Os indícios devem ser ignorados, focando apenas na prevenção.", "Far-se-á a comunicação à autoridade policial competente.", "O investigador do SIPAER adquire poder de polícia para efetuar prisões."], answer: "Far-se-á a comunicação à autoridade policial competente." },
  { question: "De acordo com o Art. 88-N, quem tem a autoridade para vasculhar ou remover destroços, exceto para salvar vidas?", options: ["A autoridade policial.", "O explorador da aeronave.", "Apenas a autoridade de investigação SIPAER ou com sua autorização.", "A companhia de seguros."], answer: "Apenas a autoridade de investigação SIPAER ou com sua autorização." },
  { question: "De quem é o dever de remover os destroços da aeronave e arcar com as despesas decorrentes, segundo o Art. 88-Q?", options: ["Do CENIPA.", "Do explorador da aeronave.", "Da administração aeroportuária.", "Da União."], answer: "Do explorador da aeronave." },
  { question: "Qual é a definição de 'Aeronave' segundo o Art. 106 do CBA?", options: ["Todo aparelho manobrável em voo, apto a transportar pessoas ou coisas.", "Todo aparelho que possa sustentar-se no espaço aéreo, apto a transportar pessoas ou coisas.", "Todo aparelho manobrável em voo, que possa sustentar-se e circular no espaço aéreo, mediante reações aerodinâmicas, apto a transportar pessoas ou coisas.", "Qualquer objeto mais pesado que o ar que possa voar."], answer: "Todo aparelho manobrável em voo, que possa sustentar-se e circular no espaço aéreo, mediante reações aerodinâmicas, apto a transportar pessoas ou coisas." },
  { question: "De acordo com o Art. 107, as aeronaves civis se dividem em quais categorias?", options: ["Públicas e Privadas.", "Nacionais e Estrangeiras.", "De Transporte e de Aviação Geral.", "De Asa Fixa e Asa Rotativa."], answer: "Públicas e Privadas." },
  { question: "Conforme o Art. 107, § 3º, como são definidas as 'aeronaves públicas'?", options: ["São as aeronaves militares.", "São as aeronaves destinadas ao serviço do Poder Público, inclusive as requisitadas.", "São as aeronaves que pertencem a empresas de transporte aéreo público.", "São todas as aeronaves que não pertencem a uma pessoa física."], answer: "São as aeronaves destinadas ao serviço do Poder Público, inclusive as requisitadas." },
  { question: "De acordo com o Art. 108, como é definida a nacionalidade de uma aeronave?", options: ["Pelo Estado de fabricação.", "Pelo Estado de operação do explorador.", "Pelo Estado em que esteja matriculada.", "Pela nacionalidade do seu proprietário."], answer: "Pelo Estado em que esteja matriculada." },
  { question: "A matrícula de uma aeronave será cancelada 'ex officio' (Art. 112) quando:", options: ["O proprietário solicitar.", "A aeronave for matriculada em outro país, ou ocorrer seu abandono ou perecimento.", "A aeronave sofrer um acidente, independentemente dos danos.", "O Certificado de Aeronavegabilidade vencer."], answer: "A aeronave for matriculada em outro país, ou ocorrer seu abandono ou perecimento." },
  { question: "Segundo o Art. 120, § 2º, quando uma aeronave é considerada 'perecida'?", options: ["Imediatamente após a confirmação de um acidente fatal.", "Após 30 dias da última notícia oficial.", "Quando for impossível sua recuperação ou após 180 dias da última notícia oficial.", "Quando o explorador declara o abandono."], answer: "Quando for impossível sua recuperação ou após 180 dias da última notícia oficial." },
  { question: "Quem é considerado 'operador ou explorador' de aeronave, conforme o Art. 123?", options: ["Apenas o proprietário da aeronave.", "Apenas o prestador de serviços aéreos.", "O proprietário, o fretador ou o arrendatário que tenha a condução técnica e autoridade sobre a tripulação.", "O Comandante da aeronave."], answer: "O proprietário, o fretador ou o arrendatário que tenha a condução técnica e autoridade sobre a tripulação." },
  { question: "De acordo com o Art. 124, § 1º, se o nome do explorador não constar no RAB, quem será reputado explorador até prova em contrário?", options: ["O Comandante.", "O proprietário da aeronave.", "O arrendatário.", "Ninguém, a aeronave fica interditada."], answer: "O proprietário da aeronave." },
  { question: "Se for provado que havia um explorador, mas seu nome não estava no RAB (Art. 124, § 2º), qual será a responsabilidade por danos?", options: ["Apenas o explorador não registrado responde.", "Apenas o proprietário responde.", "Haverá solidariedade do explorador e do proprietário.", "A União responde pelos danos."], answer: "Haverá solidariedade do explorador e do proprietário." },
  { question: "Segundo o Art. 156, § 1º, a função REMUNERADA a bordo de aeronaves operadas por empresa brasileira é privativa de:", options: ["Brasileiros natos ou naturalizados, titulares de licenças específicas.", "Qualquer pessoa habilitada, independente da nacionalidade.", "Brasileiros, exceto em voos internacionais.", "Pilotos brasileiros e comissários de qualquer nacionalidade."], answer: "Brasileiros natos ou naturalizados, titulares de licenças específicas." },
  { question: "Conforme o Art. 156, § 3º, qual é o limite para o emprego de comissários estrangeiros em serviço aéreo internacional de empresa brasileira?", options: ["Não há limite.", "Não podem exceder 1/3 (um terço) dos comissários a bordo.", "Não podem exceder 1/2 (metade) dos comissários a bordo.", "É totalmente proibido."], answer: "Não podem exceder 1/3 (um terço) dos comissários a bordo." },
  { question: "Em qual situação, de acordo com o Art. 158, instrutores estrangeiros podem ser admitidos como tripulantes em caráter provisório?", options: ["A qualquer tempo, por decisão da empresa.", "Na falta de tripulantes brasileiros, por no máximo 6 meses.", "Apenas em aeronaves de matrícula estrangeira.", "Na falta de tripulantes brasileiros, por tempo indeterminado."], answer: "Na falta de tripulantes brasileiros, por no máximo 6 meses." },
  { question: "De acordo com o Art. 163, o titular de uma licença com certificados válidos pode ser submetido a novos exames?", options: ["Não, a validade dos certificados o protege.", "Sim, se houver indício comprometedor de sua aptidão técnica ou física.", "Sim, mas apenas por ordem judicial.", "Não, exceto se ele reprovar em um voo de revalidação."], answer: "Sim, se houver indício comprometedor de sua aptidão técnica ou física." },
  { question: "Segundo o Art. 165, quem designa o Comandante da aeronave?", options: ["A ANAC.", "O proprietário ou explorador.", "O Chefe de Operações da empresa.", "O próprio Comandante, por antiguidade."], answer: "O proprietário ou explorador." },
  { question: "Qual é a responsabilidade principal do Comandante, definida no Art. 166?", options: ["Apenas pela guarda de valores e mala postal.", "Pela operação e segurança da aeronave.", "Pelo cumprimento dos horários de voo.", "Pela manutenção da aeronave antes do voo."], answer: "Pela operação e segurança da aeronave." },
  { question: "Conforme o Art. 167, quando se inicia a autoridade do Comandante?", options: ["Quando a aeronave inicia o táxi.", "No momento em que ele se apresenta para o voo.", "Quando as portas da aeronave são fechadas.", "Apenas após a decolagem."], answer: "No momento em que ele se apresenta para o voo." },
  { question: "Em um pouso forçado (Art. 167, Parágrafo único), a autoridade do Comandante persiste até quando?", options: ["Até a aeronave ser removida.", "Até que as autoridades competentes assumam a responsabilidade.", "Por no máximo 24 horas.", "A autoridade cessa imediatamente após o pouso."], answer: "Até que as autoridades competentes assumam a responsabilidade." },
  { question: "O Comandante (Art. 168) pode desembarcar um passageiro que comprometa a boa ordem ou ponha em risco a segurança?", options: ["Não, apenas a Polícia Federal pode.", "Sim, ele exerce autoridade sobre as pessoas a bordo.", "Não, ele deve apenas adverti-lo verbalmente.", "Sim, mas apenas no aeroporto de destino."], answer: "Sim, ele exerce autoridade sobre as pessoas a bordo." }
];

const quizDataDireitoAeronauticoN2 = [
  { question: "Segundo o Art. 171, as decisões tomadas pelo Comandante (como alijamento de carga ou desembarque de passageiro) devem ser registradas onde?", options: ["Apenas no relatório de voo.", "No Diário de Bordo e comunicadas à autoridade aeronáutica após a viagem.", "Na caixa preta da aeronave.", "Apenas comunicadas verbalmente à empresa."], answer: "No Diário de Bordo e comunicadas à autoridade aeronáutica após a viagem." },
  { question: "O Comandante pode delegar atribuições a outro membro da tripulação (Art. 170)?", options: ["Sim, quaisquer atribuições, incluindo as de segurança.", "Não, o Comandante não pode delegar nenhuma atribuição.", "Sim, menos as que se relacionem com a segurança do voo.", "Sim, mas apenas ao Copiloto."], answer: "Sim, menos as que se relacionem com a segurança do voo." },
  { question: "De acordo com o Art. 174-A, os serviços aéreos são considerados atividades de qual natureza?", options: ["Serviço público essencial, de monopólio da União.", "Atividades econômicas de interesse público submetidas à regulação.", "Atividades privadas sem interesse público.", "Serviços de competência exclusiva dos Estados."], answer: "Atividades econômicas de interesse público submetidas à regulação." },
  { question: "Conforme o Art. 215, como é definido o 'transporte doméstico'?", options: ["Qualquer transporte realizado por uma empresa brasileira.", "Todo transporte em que os pontos de partida, intermediários e de destino estejam situados em Território Nacional.", "Transporte realizado apenas dentro de um mesmo Estado.", "Transporte que não sobrevoe o oceano."], answer: "Todo transporte em que os pontos de partida, intermediários e de destino estejam situados em Território Nacional." },
  { question: "Um voo de transporte doméstico (Art. 215, Parágrafo único) perde esse caráter se, por motivo de força maior, fizer escala em território estrangeiro?", options: ["Sim, passa a ser considerado internacional.", "Não, desde que os pontos de partida e destino estejam em território brasileiro.", "Sim, e precisa de autorização diplomática.", "Apenas se a escala durar mais de 4 horas."], answer: "Não, desde que os pontos de partida e destino estejam em território brasileiro." },
  { question: "Segundo o Art. 216, os serviços aéreos de transporte doméstico são reservados a quem?", options: ["Qualquer empresa estrangeira com autorização da ANAC.", "Pessoas jurídicas constituídas sob as leis brasileiras, com sede e administração no País.", "Empresas que tenham pelo menos 50% de capital nacional.", "Empresas com aeronaves de matrícula exclusivamente brasileira."], answer: "Pessoas jurídicas constituídas sob as leis brasileiras, com sede e administração no País." },
  { question: "O que define um 'contrato de transporte aéreo' (Art. 222)?", options: ["A obrigação do empresário de transportar passageiro, bagagem ou carga, mediante pagamento.", "O acordo verbal entre o passageiro e o Comandante.", "O bilhete de passagem, exclusivamente.", "A autorização de voo emitida pelo DECEA."], answer: "A obrigação do empresário de transportar passageiro, bagagem ou carga, mediante pagamento." },
  { question: "De acordo com o Art. 223, se um transporte é ajustado num único ato jurídico (ex: um bilhete), mas executado por várias empresas, quantos contratos existem?", options: ["Vários contratos, um com cada transportador.", "Considera-se que existe um só contrato de transporte.", "Dois contratos: um nacional e um internacional.", "O contrato é nulo por envolver múltiplos transportadores."], answer: "Considera-se que existe um só contrato de transporte." },
  { question: "O que é um 'transportador de fato' (Art. 225)?", options: ["É o mesmo que o transportador contratual.", "O que realiza o transporte (todo ou parte), presumidamente autorizado pelo transportador contratual, sem se confundir com ele.", "O agente de viagens que vendeu a passagem.", "O proprietário da aeronave que não a explora."], answer: "O que realiza o transporte (todo ou parte), presumidamente autorizado pelo transportador contratual, sem se confundir com ele." },
  { question: "A falta, irregularidade ou perda do bilhete de passagem prejudica a existência do contrato de transporte (Art. 226)?", options: ["Sim, sem o bilhete físico, o contrato é nulo.", "Sim, mas apenas em voos internacionais.", "Não, a falta do bilhete não prejudica a existência e eficácia do contrato.", "Não, mas o passageiro perde o direito a indenização."], answer: "Não, a falta do bilhete não prejudica a existência e eficácia do contrato." },
  { question: "Qual é a validade de um bilhete de passagem, conforme o Art. 228?", options: ["6 meses a partir da emissão.", "1 ano a partir da emissão.", "2 anos a partir da emissão.", "É válida apenas para a data marcada no bilhete."], answer: "1 ano a partir da emissão." },
  { question: "Se o transportador cancelar a viagem (Art. 229), o passageiro tem direito a quê?", options: ["Apenas a remarcação para o próximo voo disponível.", "A 50% do valor do bilhete.", "Ao reembolso do valor já pago do bilhete.", "A um voucher de crédito, obrigatoriamente."], answer: "Ao reembolso do valor já pago do bilhete." },
  { question: "Em caso de atraso da partida por mais de 4 horas (Art. 230), quais são as opções do passageiro?", options: ["Apenas aguardar o voo.", "Embarcar em voo equivalente (se houver) ou ser restituído de imediato do valor do bilhete.", "Receber alimentação e hospedagem, mas não pode pedir reembolso.", "Processar a empresa, mas deve realizar o voo."], answer: "Embarcar em voo equivalente (se houver) ou ser restituído de imediato do valor do bilhete." },
  { question: "Se o transporte sofrer interrupção ou atraso em aeroporto de escala por mais de 4 horas (Art. 231), quem arca com as despesas de alimentação e hospedagem?", options: ["O passageiro.", "A administração aeroportuária.", "O transportador contratual.", "A ANAC."], answer: "O transportador contratual." },
  { question: "Conforme o Art. 232, § 2º, o que pode acontecer a um passageiro que pratique um ato de indisciplina gravíssimo?", options: ["Ele é multado pela ANAC.", "O prestador de serviços aéreos poderá deixar de vender bilhete a ele por até 12 meses.", "Ele é banido permanentemente de voar.", "Ele deve pedir desculpas formais ao Comandante."], answer: "O prestador de serviços aéreos poderá deixar de vender bilhete a ele por até 12 meses." },
  { question: "A execução do contrato de transporte de passageiro (Art. 233) compreende quais operações?", options: ["Apenas o período em que o passageiro está a bordo da aeronave.", "As operações de embarque e desembarque, além das efetuadas a bordo.", "O percurso do passageiro de casa até o aeroporto.", "O check-in e o despacho de bagagem."], answer: "As operações de embarque e desembarque, além das efetuadas a bordo." },
  { question: "O que define a 'operação de embarque' (Art. 233, § 1º)?", options: ["O momento em que o passageiro entra no aeroporto.", "Desde quando o passageiro despachado transpõe o limite da área pública e entra na aeronave.", "O momento em que o passageiro se senta na poltrona.", "O percurso do portão de embarque até a aeronave."], answer: "Desde quando o passageiro despachado transpõe o limite da área pública e entra na aeronave." },
  { question: "O recebimento da bagagem sem protesto (Art. 234, § 4º) faz presumir o quê?", options: ["Que o passageiro desistiu de seus direitos.", "O seu bom estado.", "Que a bagagem foi extraviada.", "Que o valor declarado estava correto."], answer: "O seu bom estado." },
  { question: "De acordo com o Art. 256, o transportador responde por quais danos ao passageiro?", options: ["Apenas por morte ou lesão a bordo.", "Apenas por atraso no transporte.", "Morte ou lesão (em acidente durante o contrato) e atraso do transporte.", "Apenas por danos à bagagem de mão."], answer: "Morte ou lesão (em acidente durante o contrato) e atraso do transporte." },
  { question: "Em qual situação (Art. 256, § 1º) o transportador NÃO será responsável pela morte ou lesão do passageiro?", options: ["Se o acidente foi causado por falha mecânica.", "Se o acidente decorrer de culpa exclusiva do passageiro ou de seu estado de saúde.", "Se o acidente foi causado por mau tempo.", "Em nenhuma hipótese, a responsabilidade é sempre objetiva."], answer: "Se o acidente decorrer de culpa exclusiva do passageiro ou de seu estado de saúde." },
  { question: "Para fins de isenção de responsabilidade por atraso (Art. 256, § 3º), o que é considerado caso fortuito ou força maior?", options: ["Manutenção não programada da aeronave.", "Falta de tripulação.", "Restrições ao pouso por condições meteorológicas adversas impostas por órgão de controle.", "Congestionamento do tráfego aéreo por excesso de voos."], answer: "Restrições ao pouso por condições meteorológicas adversas impostas por órgão de controle." },
  { question: "Se o transportador for isento de responsabilidade por atraso (devido a caso fortuito/força maior), ele ainda é obrigado a prestar assistência material (Art. 256, § 4º)?", options: ["Não, a isenção de responsabilidade é total.", "Sim, a isenção de responsabilidade (indenização) não o desobriga de oferecer assistência material, reacomodação ou reembolso.", "Apenas se o passageiro solicitar judicialmente.", "Apenas a hospedagem, não a alimentação."], answer: "Sim, a isenção de responsabilidade (indenização) não o desobriga de oferecer assistência material, reacomodação ou reembolso." },
  { question: "No caso de transportes sucessivos (Art. 258), contra quem o passageiro (ou sucessor) deve entrar com ação por acidente ou atraso?", options: ["Contra o primeiro transportador, que assumiu o contrato.", "Contra todos os transportadores, que são solidários.", "Apenas contra o transportador que efetuou o transporte no curso do qual ocorreu o evento.", "Contra a agência de viagens que vendeu o bilhete."], answer: "Apenas contra o transportador que efetuou o transporte no curso do qual ocorreu o evento." },
  { question: "Se o transporte for contratado com 'A' (contratual) mas executado por 'B' (de fato), como funciona a responsabilidade (Art. 259)?", options: ["Apenas o transportador de fato (B) responde.", "Apenas o transportador contratual (A) responde.", "O passageiro pode demandar tanto o contratual como o de fato, respondendo ambos solidariamente.", "O passageiro deve escolher apenas um deles para demandar."], answer: "O passageiro pode demandar tanto o contratual como o de fato, respondendo ambos solidariamente." },
  { question: "Quando não há contrato de transporte (ex: voo privado), o proprietário da aeronave (Art. 267) responde por quais danos?", options: ["Ele não responde por danos, pois não há contrato.", "Apenas por danos ao pessoal técnico a bordo.", "Por danos ao pessoal técnico a bordo e às pessoas e bens na superfície.", "Apenas por danos a pessoas e bens na superfície."], answer: "Por danos ao pessoal técnico a bordo e às pessoas e bens na superfície." },
  { question: "Qual autoridade é competente para tipificar as infrações ao CBA e definir as sanções (Art. 288)?", options: ["A autoridade policial.", "A autoridade de aviação civil (ANAC).", "O DECEA.", "O CENIPA."], answer: "A autoridade de aviação civil (ANAC)." },
  { question: "Quais são as providências administrativas que a autoridade aeronáutica pode tomar em caso de infração (Art. 289)?", options: ["Apenas multa.", "Multa, suspensão, cassação, detenção, interdição ou apreensão.", "Apenas suspensão ou cassação.", "Apenas detenção da aeronave."], answer: "Multa, suspensão, cassação, detenção, interdição ou apreensão." },
  { question: "Em qual situação a autoridade aeronáutica pode requisitar auxílio da força policial (Art. 290)?", options: ["Para aplicar uma multa.", "Para obter a detenção de infratores ou de aeronave que ponha em perigo a segurança pública.", "Para fiscalizar o pátio do aeroporto.", "Para qualquer infração, por menor que seja."], answer: "Para obter a detenção de infratores ou de aeronave que ponha em perigo a segurança pública." },
  { question: "Se uma infração ao CBA também constituir crime (Art. 291, § 1º), o que a autoridade aeronáutica deve fazer?", options: ["Ignorar o crime e focar na sanção administrativa.", "Levar o fato imediatamente ao conhecimento da autoridade policial ou judicial competente.", "Aplicar a multa e arquivar o processo.", "Aguardar a conclusão do processo administrativo primeiro."], answer: "Levar o fato imediatamente ao conhecimento da autoridade policial ou judicial competente." },
  { question: "Se um membro da tripulação de um serviço aéreo cometer um crime e precisar ser detido (Art. 291, § 2º), o que a autoridade aeronáutica deve priorizar?", options: ["A detenção imediata, mesmo que cancele o voo.", "Tomar as medidas que possibilitem a continuação do voo, concomitantemente à comunicação policial.", "Aguardar o fim do voo para efetuar a detenção.", "Substituir toda a tripulação por uma nova."], answer: "Tomar as medidas que possibilitem a continuação do voo, concomitantemente à comunicação policial." },
  { question: "Qual é o prazo máximo de uma 'suspensão' de certificado ou licença, incluindo a prorrogação (Art. 296)?", options: ["90 dias, improrrogáveis.", "180 dias, improrrogáveis.", "180 dias, podendo ser prorrogada uma vez por igual período (total 360 dias).", "Indeterminado, até a resolução do problema."], answer: "180 dias, podendo ser prorrogada uma vez por igual período (total 360 dias)." },
  { question: "Segundo o Art. 297, a pessoa jurídica empregadora (empresa) responde pelas infrações cometidas por seus empregados no exercício da função?", options: ["Não, a responsabilidade é exclusiva do empregado.", "Sim, responde solidariamente com eles.", "Apenas se for comprovado dolo da empresa.", "Não, exceto em casos de acidentes fatais."], answer: "Sim, responde solidariamente com eles." },
  { question: "De acordo com o Art. 299, qual é a sanção para um procedimento que revele falta de idoneidade profissional?", options: ["Apenas advertência.", "Multa, suspensão ou cassação de certificados.", "Detenção da aeronave.", "Prisão do profissional."], answer: "Multa, suspensão ou cassação de certificados." },
  { question: "A 'cassação' de um certificado (Art. 300) dependerá de qual procedimento?", options: ["Decisão sumária da autoridade.", "Pagamento de multa.", "Inquérito administrativo, assegurada a defesa ao infrator.", "Ordem judicial, apenas."], answer: "Inquérito administrativo, assegurada a defesa ao infrator." },
  { question: "Pilotar aeronave com certificado de habilitação (CHT) ou capacidade física (CMA) vencidos é uma infração (Art. 302, II, d) que resulta em qual sanção?", options: ["Multa.", "Advertência.", "Cassação imediata.", "Apreensão da aeronave."], answer: "Multa." },
  { question: "Operar aeronave em estado de embriaguez (Art. 302, II, q) é uma infração que resulta em qual sanção administrativa?", options: ["Multa.", "Advertência.", "Suspensão.", "Apreensão da aeronave."], answer: "Multa." },
  { question: "Ministrar instrução de voo sem estar habilitado para tal (Art. 302, II, u) é uma infração punível com:", options: ["Advertência.", "Cassação da licença de piloto.", "Multa.", "Apreensão da aeronave."], answer: "Multa." },
  { question: "Em qual caso a aeronave poderá ser 'detida' (Art. 303)?", options: ["Se o piloto cometer qualquer infração de tráfego aéreo.", "Se voar no espaço aéreo brasileiro com infração das autorizações, ou desrespeitar o pouso obrigatório em aeroporto internacional.", "Se estiver com a pintura irregular.", "Se atrasar o pagamento da tarifa aeroportuária."], answer: "Se voar no espaço aéreo brasileiro com infração das autorizações, ou desrespeitar o pouso obrigatório em aeroporto internacional." },
  { question: "Se uma aeronave for compelida a pousar e não obedecer (Art. 303, § 2º), ela pode ser classificada como hostil e sujeita à medida de destruição?", options: ["Não, a destruição nunca é permitida.", "Sim, mas apenas após esgotados os meios coercitivos e com autorização do Presidente da República ou autoridade delegada.", "Sim, por decisão do controlador de voo.", "Sim, por decisão da autoridade policial."], answer: "Sim, mas apenas após esgotados os meios coercitivos e com autorização do Presidente da República ou autoridade delegada." },
  { question: "A 'interdição' da aeronave (Art. 305) pode ocorrer em qual situação?", options: ["Durante a investigação de acidente em que estiver envolvida.", "Por qualquer multa de trânsito aéreo.", "Se o passageiro fumar a bordo.", "Se o voo atrasar mais de 4 horas."], answer: "Durante a investigação de acidente em que estiver envolvida." },
  { question: "A autoridade aeronáutica (Art. 307) pode interditar uma aeronave a pedido de qual outra autoridade?", options: ["Apenas da autoridade judicial.", "Da autoridade aduaneira (Receita), de polícia ou de saúde.", "Da administração do aeroporto.", "Do operador da aeronave concorrente."], answer: "Da autoridade aduaneira (Receita), de polícia ou de saúde." },
  { question: "Qual o prazo máximo da interdição solicitada por autoridade aduaneira, de polícia ou de saúde (Art. 307)?", options: ["Indeterminado.", "Não superior a 15 (quinze) dias.", "Até 180 dias.", "48 horas."], answer: "Não superior a 15 (quinze) dias." },
  { question: "O que é a 'apreensão' da aeronave (Art. 308)?", options: ["É o mesmo que a interdição.", "É mantê-la estacionada (com ou sem remoção) para preservar a eficácia da detenção ou interdição.", "É a tomada da aeronave pelo Estado.", "É a multa aplicada ao explorador."], answer: "É mantê-la estacionada (com ou sem remoção) para preservar a eficácia da detenção ou interdição." },
  { question: "A apreensão da aeronave (Art. 309), ressalvadas as hipóteses do CBA, só pode ocorrer em cumprimento a quê?", options: ["Ordem da ANAC.", "Ordem do DECEA.", "Ordem judicial.", "Pedido do proprietário."], answer: "Ordem judicial." },
  { question: "O proprietário ou explorador da aeronave detida, interditada ou apreendida terá direito à indenização (Art. 311)?", options: ["Sim, sempre.", "Apenas se provar que não cometeu infração.", "Não, em qualquer dos casos previstos no Capítulo.", "Sim, se a aeronave ficar parada por mais de 15 dias."], answer: "Não, em qualquer dos casos previstos no Capítulo." },
  { question: "A quem se aplica o Art. 12 do CBA?", options: ["Apenas ao tráfego aéreo e à navegação aérea.", "A toda a infraestrutura aeronáutica, aeronaves, tripulação e serviços relacionados ao voo.", "Apenas a aeronaves de matrícula brasileira.", "Apenas a aeródromos públicos."], answer: "A toda a infraestrutura aeronáutica, aeronaves, tripulação e serviços relacionados ao voo." },
  { question: "O que acontece se um proprietário de solo não receber a garantia de reparação por danos de um pouso de emergência (Art. 16, § 2º)?", options: ["Ele deve liberar a aeronave e cobrar judicialmente.", "Ele está autorizado a sequestrar a aeronave e retê-la até a garantia se efetivar.", "Ele pode vender a aeronave para cobrir os custos.", "Ele deve chamar a autoridade policial para prender o piloto."], answer: "Ele está autorizado a sequestrar a aeronave e retê-la até a garantia se efetivar." },
  { question: "O lançamento de coisas de bordo de aeronave (Art. 16, § 3º) é permitido?", options: ["Sim, a qualquer momento, a critério do Comandante.", "Não, é estritamente proibido.", "Dependerá de permissão prévia da autoridade aeronáutica, salvo caso de emergência.", "Sim, desde que seja sobre o mar ou áreas não habitadas."], answer: "Dependerá de permissão prévia da autoridade aeronáutica, salvo caso de emergência." },
  { question: "Voos de acrobacia que possam constituir perigo (Art. 17) são proibidos. Qual é a exceção?", options: ["Voos de instrução em aeroclubes.", "Voos de prova, produção e demonstração, quando realizados pelo fabricante ou unidades especiais, seguindo as normas.", "Voos em áreas não controladas (Classe G).", "Voos de aeronaves militares."], answer: "Voos de prova, produção e demonstração, quando realizados pelo fabricante ou unidades especiais, seguindo as normas." },
  { question: "A quem se aplica o Art. 19, que diz que aeronaves só podem pousar ou decolar em aeródromo cujas características comportem suas operações?", options: ["Apenas a voos IFR.", "Apenas a aeronaves de transporte aéreo (RBAC 121).", "A todas as aeronaves, salvo motivo de força maior.", "Apenas a aeronaves estrangeiras."], answer: "A todas as aeronaves, salvo motivo de força maior." }
];

// NÍVEL 1: Conceitos, Magnetismo e Orientação (50 Questões)
const quizNavN1 = [
    { question: "A ciência que permite conduzir uma aeronave de um ponto a outro da superfície da Terra chama-se:", options: ["Pilotagem.", "Navegação Aérea.", "Aerodinâmica.", "Meteorologia."], answer: "Navegação Aérea." },
    { question: "O método de navegação que utiliza referências visuais na superfície terrestre (rios, estradas) é:", options: ["Navegação Estimada.", "Navegação Visual ou Contato.", "Navegação Astronômica.", "Radio-navegação."], answer: "Navegação Visual ou Contato." },
    { question: "A navegação que utiliza bússola, velocímetro e relógio para determinar a posição a partir de um ponto conhecido é a:", options: ["Navegação Estimada.", "Navegação Visual.", "Navegação Eletrônica.", "Navegação Celestial."], answer: "Navegação Estimada." },
    { question: "Qual instrumento é fundamental na Navegação Celestial?", options: ["Radar.", "Sextante.", "ADF.", "Transponder."], answer: "Sextante." },
    { question: "Os círculos máximos que passam pelos polos geográficos são chamados de:", options: ["Paralelos.", "Meridianos.", "Linhas de Rumo.", "Linhas Isogônicas."], answer: "Meridianos." },
    { question: "O único círculo máximo que é perpendicular ao eixo polar da Terra é o:", options: ["Meridiano de Greenwich.", "Trópico de Câncer.", "Equador.", "Círculo Polar Antártico."], answer: "Equador." },
    { question: "A latitude é contada a partir do Equador e vai de:", options: ["00° a 180°.", "00° a 90° Norte ou Sul.", "00° a 360°.", "00° a 45° Leste ou Oeste."], answer: "00° a 90° Norte ou Sul." },
    { question: "A longitude é contada a partir do Meridiano de Greenwich e vai de:", options: ["00° a 90°.", "00° a 180° Leste ou Oeste.", "00° a 360°.", "00° a 45° Norte ou Sul."], answer: "00° a 180° Leste ou Oeste." },
    { question: "O movimento da Terra em torno do seu próprio eixo chama-se:", options: ["Translação.", "Rotação.", "Precessão.", "Nutação."], answer: "Rotação." },
    { question: "O movimento de Rotação da Terra é a causa principal de:", options: ["As estações do ano.", "A sucessão dos dias e das noites.", "Os eclipses.", "As marés."], answer: "A sucessão dos dias e das noites." },
    { question: "O ângulo formado entre o Norte Verdadeiro e o Norte Magnético é a:", options: ["Declinação Magnética.", "Inclinação Magnética.", "Desvio de Bússola.", "Proa Magnética."], answer: "Declinação Magnética." },
    { question: "Linhas que unem pontos de mesma declinação magnética chamam-se:", options: ["Isogônicas.", "Agônicas.", "Isóbaras.", "Isotermas."], answer: "Isogônicas." },
    { question: "A linha que une pontos de declinação magnética nula (zero) é a:", options: ["Linha do Equador.", "Linha Agônica.", "Linha Isogônica.", "Linha de Mudança de Data."], answer: "Linha Agônica." },
    { question: "O desvio da bússola é causado por:", options: ["Ventos fortes.", "Campos magnéticos gerados pelos metais e equipamentos da própria aeronave.", "Magnetismo terrestre.", "Declinação magnética."], answer: "Campos magnéticos gerados pelos metais e equipamentos da própria aeronave." },
    { question: "A direção do eixo longitudinal da aeronave (nariz) em relação a um meridiano é a:", options: ["Rota.", "Rumo.", "Proa.", "Deriva."], answer: "Proa." },
    { question: "O ângulo entre a proa da aeronave e o rumo percorrido (efeito do vento) chama-se:", options: ["Correção de deriva.", "Deriva.", "Declinação.", "Desvio."], answer: "Deriva." },
    { question: "O rumo é definido como:", options: ["A direção do nariz do avião.", "A direção da trajetória percorrida ou pretendida sobre o solo.", "A direção do vento.", "A direção magnética."], answer: "A direção da trajetória percorrida ou pretendida sobre o solo." },
    { question: "A unidade padrão de distância horizontal na aviação é:", options: ["Quilômetro.", "Milha Terrestre.", "Milha Náutica.", "Metro."], answer: "Milha Náutica." },
    { question: "A unidade padrão de velocidade na aviação (milhas náuticas por hora) é o:", options: ["Km/h.", "Mach.", "Nó (Knot).", "Mph."], answer: "Nó (Knot)." },
    { question: "A distância vertical de um ponto ou aeronave até o Nível Médio do Mar (MSL) é:", options: ["Altura.", "Altitude.", "Nível de Voo.", "Elevação."], answer: "Altitude." },
    { question: "A distância vertical de um ponto ou aeronave até o solo (superfície) é:", options: ["Altitude.", "Altura.", "Elevação.", "Altitude Pressão."], answer: "Altura." },
    { question: "A elevação é a distância vertical de um ponto no solo até:", options: ["O nível do mar.", "O centro da terra.", "A aeronave.", "A isóbara de 1013 hPa."], answer: "O nível do mar." },
    { question: "O instrumento que indica a proa magnética baseando-se no campo magnético da Terra é:", options: ["Giro Direcional.", "Bússola.", "Altímetro.", "Velocímetro."], answer: "Bússola." },
    { question: "O Norte Verdadeiro é a direção do:", options: ["Polo Norte Magnético.", "Polo Norte Geográfico.", "Proa da aeronave.", "Rumo da aeronave."], answer: "Polo Norte Geográfico." },
    { question: "Os pontos colaterais são:", options: ["N, S, E, W.", "NE, SE, SW, NW.", "NNE, ENE, SSE, SSW.", "Cima, Baixo, Esquerda, Direita."], answer: "NE, SE, SW, NW." },
    { question: "O movimento de translação da Terra dá origem a:", options: ["Dias e noites.", "Fusos horários.", "Estações do ano.", "Marés."], answer: "Estações do ano." },
    { question: "Um grau de latitude na superfície terrestre equivale a:", options: ["1 NM.", "30 NM.", "60 NM.", "100 NM."], answer: "60 NM." },
    { question: "Um minuto de arco de latitude equivale a:", options: ["1 NM.", "10 NM.", "60 NM.", "1 Km."], answer: "1 NM." },
    { question: "A Linha Internacional de Data (LID) corresponde aproximadamente ao meridiano de:", options: ["000°.", "090°.", "180°.", "045°."], answer: "180°." },
    { question: "A hora UTC (Universal Time Coordinated) também é conhecida como:", options: ["Hora Local.", "Hora Zulu.", "Hora Legal.", "Hora de Brasília."], answer: "Hora Zulu." },
    { question: "O arco de círculo máximo compreendido entre dois pontos na superfície da Terra é a:", options: ["Distância ortodrômica (menor distância).", "Linha de rumo.", "Linha agônica.", "Loxodromia."], answer: "Distância ortodrômica (menor distância)." },
    { question: "A diferença horária entre cada fuso horário padrão é de:", options: ["30 minutos.", "1 hora.", "2 horas.", "4 horas."], answer: "1 hora." },
    { question: "Cada fuso horário compreende uma faixa de longitude de:", options: ["10 graus.", "15 graus.", "20 graus.", "30 graus."], answer: "15 graus." },
    { question: "A hora legal (HLE) é a hora referente ao:", options: ["Meridiano de Greenwich.", "Meridiano do observador.", "Meridiano central do fuso.", "Pôr do sol."], answer: "Meridiano central do fuso." },
    { question: "A hora local (HLO) é a hora referente ao:", options: ["Meridiano de Greenwich.", "Meridiano exato do observador.", "Meridiano central do fuso.", "Horário de verão."], answer: "Meridiano exato do observador." },
    { question: "Para converter Proa Verdadeira (PV) em Proa Magnética (PM), aplicamos a:", options: ["Deriva.", "Desvio.", "Declinação Magnética.", "Inclinação."], answer: "Declinação Magnética." },
    { question: "Para converter Proa Magnética (PM) em Proa Bússola (PB), aplicamos o:", options: ["Deriva.", "Desvio.", "Declinação.", "Vento."], answer: "Desvio." },
    { question: "A direção onde o sol nasce aproxima-se do ponto cardeal:", options: ["Norte.", "Sul.", "Leste (E).", "Oeste (W)."], answer: "Leste (E)." },
    { question: "A direção onde o sol se põe aproxima-se do ponto cardeal:", options: ["Norte.", "Sul.", "Leste.", "Oeste (W)."], answer: "Oeste (W)." },
    { question: "O meridiano de 000 graus é conhecido como:", options: ["Equador.", "Meridiano de Greenwich.", "Linha de Data.", "Trópico de Câncer."], answer: "Meridiano de Greenwich." },
    { question: "A superfície da Terra é considerada geometricamente como um:", options: ["Círculo perfeito.", "Elipsoide de revolução (esferoide).", "Plano.", "Cubo."], answer: "Elipsoide de revolução (esferoide)." },
    { question: "Um pé (foot) é uma unidade utilizada para medir:", options: ["Distância horizontal.", "Velocidade.", "Altitude ou Altura.", "Peso."], answer: "Altitude ou Altura." },
    { question: "O quadrante NE (Nordeste) compreende as direções entre:", options: ["000° e 090°.", "090° e 180°.", "180° e 270°.", "270° e 360°."], answer: "000° e 090°." },
    { question: "O quadrante SE (Sudeste) compreende as direções entre:", options: ["000° e 090°.", "090° e 180°.", "180° e 270°.", "270° e 360°."], answer: "090° e 180°." },
    { question: "O quadrante SW (Sudoeste) compreende as direções entre:", options: ["000° e 090°.", "090° e 180°.", "180° e 270°.", "270° e 360°."], answer: "180° e 270°." },
    { question: "O quadrante NW (Noroeste) compreende as direções entre:", options: ["000° e 090°.", "090° e 180°.", "180° e 270°.", "270° e 360°."], answer: "270° e 360°." },
    { question: "O ponto subcolateral NNE fica entre:", options: ["Norte e Nordeste.", "Norte e Noroeste.", "Sul e Sudeste.", "Leste e Nordeste."], answer: "Norte e Nordeste." },
    { question: "O que é Co-latitude?", options: ["Latitude + 90°.", "90° - Latitude.", "Latitude x 2.", "Latitude / 2."], answer: "90° - Latitude." },
    { question: "Na navegação por satélite, o sistema norte-americano é o:", options: ["GLONASS.", "GALILEO.", "GPS.", "BEIDOU."], answer: "GPS." },
    { question: "O sistema inercial de navegação (INS) baseia-se em:", options: ["Sinais de rádio.", "Acelerômetros e giroscópios (autônomo).", "Estrelas.", "Referências visuais."], answer: "Acelerômetros e giroscópios (autônomo)." }
];

// NÍVEL 2: Cálculos de Conversão, Fusos e Tempo (50 Questões)
const quizNavN2 = [
    { question: "1 Milha Náutica (NM) equivale a quantos metros?", options: ["1609 m.", "1852 m.", "1000 m.", "1500 m."], answer: "1852 m." },
    { question: "1 Milha Terrestre (MT) equivale a quantos metros?", options: ["1852 m.", "1609 m.", "1000 m.", "1200 m."], answer: "1609 m." },
    { question: "1 Pé (ft) equivale a quantos metros?", options: ["0,33 m.", "0,3048 m.", "0,50 m.", "1,00 m."], answer: "0,3048 m." },
    { question: "1 Metro equivale a aproximadamente quantos pés?", options: ["3,28 pés.", "2,50 pés.", "4,00 pés.", "1,50 pés."], answer: "3,28 pés." },
    { question: "Qual a relação entre NM e MT?", options: ["1 NM = 1.5 MT.", "1 NM = 1.15 MT.", "1 NM = 0.87 MT.", "1 NM = 2.0 MT."], answer: "1 NM = 1.15 MT." },
    { question: "Se voarmos 100 NM, percorremos quantos Km?", options: ["160,9 Km.", "185,2 Km.", "200 Km.", "100 Km."], answer: "185,2 Km." },
    { question: "Se a velocidade é 150 KT, qual a velocidade em Km/h?", options: ["150 Km/h.", "277,8 Km/h.", "240 Km/h.", "300 Km/h."], answer: "277,8 Km/h." },
    { question: "Um arco de 15° de longitude corresponde a qual intervalo de tempo?", options: ["30 min.", "1 hora.", "2 horas.", "4 horas."], answer: "1 hora." },
    { question: "Um arco de 1° de longitude corresponde a qual intervalo de tempo?", options: ["1 min.", "4 min.", "10 min.", "15 min."], answer: "4 min." },
    { question: "Um arco de 30' (minutos de grau) de longitude corresponde a:", options: ["1 min.", "2 min.", "4 min.", "30 seg."], answer: "2 min." },
    { question: "Um arco de 15' (minutos de grau) de longitude corresponde a:", options: ["30 seg.", "1 min.", "2 min.", "4 min."], answer: "1 min." },
    { question: "Qual a diferença de tempo entre duas cidades separadas por 45° de longitude?", options: ["2 horas.", "3 horas.", "4 horas.", "5 horas."], answer: "3 horas." },
    { question: "Qual a diferença de tempo entre duas cidades separadas por 10° de longitude?", options: ["20 min.", "30 min.", "40 min.", "1 hora."], answer: "40 min." },
    { question: "Para longitude 045°W, qual é o fuso horário?", options: ["+2.", "+3.", "+4.", "+5."], answer: "+3." },
    { question: "Para longitude 030°E, qual é o fuso horário?", options: ["-1.", "-2.", "-3.", "+2."], answer: "-2." },
    { question: "Uma longitude de 155°W pertence a qual fuso? (Dica: 155/15 = 10, resto 5).", options: ["+9.", "+10.", "+11.", "+12."], answer: "+10." },
    { question: "Uma longitude de 175°E pertence a qual fuso? (Dica: 175/15 = 11, resto 10).", options: ["-11.", "-12.", "+12.", "-10."], answer: "-12." },
    { question: "Qual a Co-Latitude de 30°N?", options: ["30°.", "60°.", "90°.", "120°."], answer: "60°." },
    { question: "Qual a Co-Latitude de 10°S?", options: ["10°.", "80°.", "100°.", "90°."], answer: "80°." },
    { question: "Qual o Antimeridiano de 040°W?", options: ["040°E.", "140°E.", "140°W.", "180°."], answer: "140°E." },
    { question: "Qual o Antimeridiano de 120°E?", options: ["060°W.", "120°W.", "060°E.", "180°."], answer: "060°W." },
    { question: "Se são 12:00 UTC, que horas legais (HLE) são no Rio de Janeiro (Fuso +3)?", options: ["15:00.", "09:00.", "12:00.", "10:00."], answer: "09:00." },
    { question: "Se são 10:00 HLE no fuso +4, qual é a hora UTC?", options: ["06:00 Z.", "14:00 Z.", "10:00 Z.", "12:00 Z."], answer: "14:00 Z." },
    { question: "Se a HLE é 22:00 no fuso -2 (Leste), qual é a hora UTC?", options: ["20:00 Z.", "00:00 Z.", "22:00 Z.", "18:00 Z."], answer: "20:00 Z." },
    { question: "Qual a distância percorrida em 2h 30min à velocidade de 120 KT?", options: ["240 NM.", "300 NM.", "360 NM.", "200 NM."], answer: "300 NM." },
    { question: "Um avião voa a 180 KT. Quanto tempo leva para percorrer 90 NM?", options: ["15 min.", "30 min.", "45 min.", "1 hora."], answer: "30 min." },
    { question: "Se a altitude pressão é 8.000 pés e o ajuste é padrão, qual a altura aproximada em metros?", options: ["2.000 m.", "2.438 m.", "3.000 m.", "1.500 m."], answer: "2.438 m." },
    { question: "Um arco de meridiano de 5° corresponde a qual distância?", options: ["5 NM.", "300 NM.", "60 NM.", "500 NM."], answer: "300 NM." },
    { question: "Se a latitude é 00°00'00'', para calcular a co-latitude subtraímos de:", options: ["90°.", "89° 60'.", "89° 59' 60''.", "180°."], answer: "89° 59' 60''." },
    { question: "O recíproco (proa oposta) de 045° é:", options: ["135°.", "225°.", "315°.", "090°."], answer: "225°." },
    { question: "O recíproco de 270° é:", options: ["090°.", "180°.", "360°.", "000°."], answer: "090°." },
    { question: "Se a PV é 090° e a Declinação Magnética é 10°W, qual é a PM?", options: ["080°.", "100°.", "090°.", "110°."], answer: "100°." },
    { question: "Se a PM é 180° e a Declinação Magnética é 5°E, qual é a PV?", options: ["175°.", "185°.", "180°.", "190°."], answer: "185°." },
    { question: "Se a PM é 360° e o Desvio é 2°W, qual é a PB?", options: ["358°.", "002°.", "360°.", "000°."], answer: "002°." },
    { question: "Qual a velocidade sônica padrão ao nível do mar (aproximada)?", options: ["340 m/s.", "600 KT.", "1224 km/h.", "Todas acima."], answer: "Todas acima." },
    { question: "1500 pés equivalem a quantos metros (aprox)?", options: ["300 m.", "457 m.", "500 m.", "600 m."], answer: "457 m." },
    { question: "3000 metros equivalem a quantos pés (aprox)?", options: ["9.000 pés.", "9.842 pés.", "10.000 pés.", "12.000 pés."], answer: "9.842 pés." },
    { question: "Se a longitude é 070°W, o fuso é:", options: ["+4.", "+5.", "+6.", "+3."], answer: "+5." },
    { question: "Se a longitude é 010°E, o fuso é:", options: ["-1.", "+1.", "Z (Zero).", "-2."], answer: "-1." },
    { question: "Qual a diferença de latitude entre 10°N e 20°S?", options: ["10°.", "20°.", "30°.", "15°."], answer: "30°." },
    { question: "Qual a diferença de latitude entre 15°N e 45°N?", options: ["30°.", "60°.", "45°.", "15°."], answer: "30°." },
    { question: "Qual a diferença de longitude entre 010°W e 010°E?", options: ["0°.", "10°.", "20°.", "5°."], answer: "20°." },
    { question: "Qual a diferença de longitude entre 050°W e 080°W?", options: ["30°.", "130°.", "50°.", "80°."], answer: "30°." },
    { question: "Se viajarmos para Oeste, ao cruzar a Linha Internacional de Data (180°):", options: ["Diminuímos 1 dia.", "Somamos 1 dia.", "Mantemos a data.", "Mudamos apenas a hora."], answer: "Somamos 1 dia." },
    { question: "Se viajarmos para Leste, ao cruzar a Linha Internacional de Data (180°):", options: ["Diminuímos 1 dia.", "Somamos 1 dia.", "Mantemos a data.", "Mudamos o ano."], answer: "Diminuímos 1 dia." },
    { question: "Se o Sol está a pino (12:00 solares) em 045°W, que horas solares são em Greenwich?", options: ["09:00.", "12:00.", "15:00.", "18:00."], answer: "15:00." },
    { question: "A sigla HMG refere-se a:", options: ["Hora Média de Greenwich.", "Hora Magnética Global.", "Hora Máxima Geral.", "Hora do Meridiano Grande."], answer: "Hora Média de Greenwich." },
    { question: "Convertendo 300 m/s para km/h:", options: ["1000 km/h.", "1080 km/h.", "900 km/h.", "1200 km/h."], answer: "1080 km/h." },
    { question: "Se a proa é 090° e o vento vem da direita causando uma deriva de 10°, qual é o rumo?", options: ["080°.", "100°.", "090°.", "110°."], answer: "080°." },
    { question: "Se a proa é 360° e o vento vem da esquerda causando uma deriva de 5°, qual é o rumo?", options: ["355°.", "005°.", "360°.", "010°."], answer: "005°." }
];

// NÍVEL 1: Estruturas, Componentes e Definições (50 Questões)
const quizCGANivel1 = [
    { question: "Todo aparelho manobrável em voo, capaz de sustentar-se e circular no espaço aéreo chama-se:", options: ["Aeroplano.", "Aeronave.", "Planador.", "Helicóptero."], answer: "Aeronave." },
    { question: "Aeronaves mais leves que o ar, baseadas no princípio de Arquimedes, são:", options: ["Aeródinos.", "Aeróstatos.", "Aviões.", "Girocópteros."], answer: "Aeróstatos." },
    { question: "Aeronaves mais pesadas que o ar, baseadas na Lei de Newton, são:", options: ["Aeróstatos.", "Aeródinos.", "Balões.", "Dirigíveis."], answer: "Aeródinos." },
    { question: "Qual destes é um exemplo de Aeróstato?", options: ["Helicóptero.", "Planador.", "Balão.", "Avião."], answer: "Balão." },
    { question: "Qual destes é um exemplo de Aeródino?", options: ["Dirigível.", "Balão cativo.", "Avião.", "Balão livre."], answer: "Avião." },
    { question: "O corpo principal do avião, onde ficam tripulação e carga, é a:", options: ["Asa.", "Empenagem.", "Fuselagem.", "Nacela."], answer: "Fuselagem." },
    { question: "A estrutura da fuselagem que suporta os esforços através do revestimento (casca) chama-se:", options: ["Tubular.", "Monocoque.", "Cantilever.", "Treliça."], answer: "Monocoque." },
    { question: "A estrutura que utiliza revestimento e reforços internos (longarinas/cavernas) chama-se:", options: ["Monocoque.", "Semi-monocoque.", "Tubular.", "Mista."], answer: "Semi-monocoque." },
    { question: "Quanto ao número de asas, um avião com dois planos de asas sobrepostos é um:", options: ["Monoplano.", "Biplano.", "Triplano.", "Sesquiplano."], answer: "Biplano." },
    { question: "Uma asa fixada na parte superior da fuselagem é classificada como:", options: ["Asa Baixa.", "Asa Média.", "Asa Alta.", "Asa Parassol."], answer: "Asa Alta." },
    { question: "Uma asa fixada acima da fuselagem por montantes (sem contato direto com o teto) é:", options: ["Asa Alta.", "Asa Parassol.", "Asa Média.", "Asa Baixa."], answer: "Asa Parassol." },
    { question: "A asa fixada na fuselagem sem suportes externos (estais) é do tipo:", options: ["Semi-cantilever.", "Cantilever.", "Biplano.", "Contraventada."], answer: "Cantilever." },
    { question: "O principal membro estrutural da asa, que resiste à flexão, é a:", options: ["Nervura.", "Longarina.", "Revestimento.", "Bordo de Ataque."], answer: "Longarina." },
    { question: "O elemento que dá o formato aerodinâmico ao perfil da asa é a:", options: ["Longarina.", "Nervura.", "Montante.", "Estai."], answer: "Nervura." },
    { question: "O conjunto de cauda responsável pela estabilidade é a:", options: ["Empenagem.", "Fuselagem.", "Asa.", "Trem de Pouso."], answer: "Empenagem." },
    { question: "As superfícies primárias de comando são:", options: ["Flap, Slat, Spoiler.", "Aileron, Leme, Profundor.", "Compensadores.", "Freios."], answer: "Aileron, Leme, Profundor." },
    { question: "O Aileron proporciona o movimento de:", options: ["Guinada.", "Arfagem.", "Rolamento (Bancagem).", "Freio."], answer: "Rolamento (Bancagem)." },
    { question: "O Leme de Direção (Rudder) proporciona o movimento de:", options: ["Rolamento.", "Arfagem.", "Guinada.", "Mergulho."], answer: "Guinada." },
    { question: "O Profundor (Leme de Profundidade) proporciona o movimento de:", options: ["Arfagem (Tangagem).", "Guinada.", "Rolamento.", "Curva."], answer: "Arfagem (Tangagem)." },
    { question: "Onde estão localizados os Ailerons?", options: ["No bordo de ataque.", "No estabilizador vertical.", "No bordo de fuga, próximos às pontas das asas.", "Na raiz da asa."], answer: "No bordo de fuga, próximos às pontas das asas." },
    { question: "Onde está localizado o Leme de Direção?", options: ["No estabilizador horizontal.", "No estabilizador vertical.", "Na asa.", "No trem de pouso."], answer: "No estabilizador vertical." },
    { question: "Onde está localizado o Profundor?", options: ["No estabilizador vertical.", "No estabilizador horizontal.", "Na asa.", "No nariz."], answer: "No estabilizador horizontal." },
    { question: "Um trem de pouso com roda no nariz e trem principal atrás é do tipo:", options: ["Convencional.", "Triciclo.", "Fixo.", "Retrátil."], answer: "Triciclo." },
    { question: "Um trem de pouso com bequilha na cauda é do tipo:", options: ["Triciclo.", "Convencional.", "Escamoteável.", "Hidráulico."], answer: "Convencional." },
    { question: "Um trem de pouso que se recolhe totalmente na fuselagem/asa é:", options: ["Fixo.", "Retrátil.", "Escamoteável.", "Triciclo."], answer: "Escamoteável." },
    { question: "Aeronaves que pousam na água são chamadas de:", options: ["Litoplanos.", "Hidroplanos.", "Planadores.", "Aeróstatos."], answer: "Hidroplanos." },
    { question: "Aeronaves que operam em terra e água são:", options: ["Anfíbias.", "Terrestres.", "Aquáticas.", "Mistas."], answer: "Anfíbias." },
    { question: "Um avião com um único motor é:", options: ["Bimotor.", "Monomotor.", "Trimotor.", "Sem motor."], answer: "Monomotor." },
    { question: "O cone que cobre o cubo da hélice chama-se:", options: ["Capô.", "Nacela.", "Spinner.", "Carenagem."], answer: "Spinner." },
    { question: "A parte da frente da asa é o:", options: ["Bordo de Fuga.", "Bordo de Ataque.", "Dorso.", "Ventre."], answer: "Bordo de Ataque." },
    { question: "A parte de trás da asa é o:", options: ["Bordo de Ataque.", "Bordo de Fuga.", "Extradorso.", "Intradorso."], answer: "Bordo de Fuga." },
    { question: "A distância de uma ponta da asa à outra é a:", options: ["Corda.", "Envergadura.", "Flecha.", "Área."], answer: "Envergadura." },
    { question: "A linha reta imaginária que une o bordo de ataque ao bordo de fuga é a:", options: ["Corda.", "Envergadura.", "Linha média.", "Eixo longitudinal."], answer: "Corda." },
    { question: "A curvatura superior da asa chama-se:", options: ["Intradorso.", "Extradorso.", "Perfil.", "Cambra."], answer: "Extradorso." },
    { question: "A curvatura inferior da asa chama-se:", options: ["Extradorso.", "Intradorso.", "Dorso.", "Ventre."], answer: "Intradorso." },
    { question: "Motores a pistão utilizam qual combustível?", options: ["Querosene (JET A-1).", "Gasolina de Aviação (AVGAS).", "Diesel.", "Hidrogênio."], answer: "Gasolina de Aviação (AVGAS)." },
    { question: "Motores a reação (Turbinas) utilizam qual combustível?", options: ["Gasolina Azul.", "Querosene de Aviação (QAV).", "Etanol.", "Metanol."], answer: "Querosene de Aviação (QAV)." },
    { question: "O Flap é um dispositivo:", options: ["Hipersustentador.", "De freio apenas.", "De estabilidade.", "De navegação."], answer: "Hipersustentador." },
    { question: "A luz de navegação na ponta da asa esquerda é:", options: ["Verde.", "Branca.", "Vermelha.", "Amarela."], answer: "Vermelha." },
    { question: "A luz de navegação na ponta da asa direita é:", options: ["Verde.", "Branca.", "Vermelha.", "Azul."], answer: "Verde." },
    { question: "A luz de navegação na cauda é:", options: ["Verde.", "Branca.", "Vermelha.", "Laranja."], answer: "Branca." },
    { question: "O sistema que mantém a atmosfera interna da cabine agradável em altitude é a:", options: ["Pressurização.", "Refrigeração.", "Oxigenação.", "Ventilação."], answer: "Pressurização." },
    { question: "Um avião capaz de transportar mais de 4 pessoas é classificado como:", options: ["Monoplace.", "Biplace.", "Triplace.", "Multiplace."], answer: "Multiplace." },
    { question: "A hélice instalada na parte traseira do motor, empurrando o avião, é do tipo:", options: ["Tratora.", "Propulsora.", "Reversível.", "Bandeira."], answer: "Propulsora." },
    { question: "A hélice instalada na frente do motor, puxando o avião, é do tipo:", options: ["Tratora.", "Propulsora.", "Fixa.", "Passo variável."], answer: "Tratora." },
    { question: "Um avião com dois motores é um:", options: ["Monomotor.", "Bimotor.", "Trimotor.", "Quadrimotor."], answer: "Bimotor." },
    { question: "O instrumento que mede a altitude é o:", options: ["Velocímetro.", "Altímetro.", "Tacômetro.", "Climb."], answer: "Altímetro." },
    { question: "O instrumento que mede a velocidade é o:", options: ["Altímetro.", "Velocímetro.", "Bússola.", "Horizonte."], answer: "Velocímetro." },
    { question: "Os freios das aeronaves geralmente atuam:", options: ["No trem do nariz.", "Nas rodas do trem principal.", "Na bequilha.", "Nos flutuadores."], answer: "Nas rodas do trem principal." },
    { question: "A estrutura que absorve o impacto do pouso chama-se:", options: ["Freio.", "Amortecedor.", "Roda.", "Pneu."], answer: "Amortecedor." }
];

// NÍVEL 2: Teoria de Voo, Aerodinâmica e Sistemas (50 Questões)
const quizCGANivel2 = [
    { question: "O Teorema de Bernoulli estabelece que:", options: ["Se a velocidade de um fluido aumenta, a pressão estática diminui.", "Se a velocidade aumenta, a pressão aumenta.", "A pressão é constante.", "Ação e reação são iguais."], answer: "Se a velocidade de um fluido aumenta, a pressão estática diminui." },
    { question: "As quatro forças que atuam em um avião em voo são:", options: ["Peso, Massa, Vento, Atrito.", "Sustentação, Peso (Gravidade), Tração (Empuxo), Arrasto.", "Velocidade, Altura, Pressão, Temperatura.", "Norte, Sul, Leste, Oeste."], answer: "Sustentação, Peso (Gravidade), Tração (Empuxo), Arrasto." },
    { question: "Para um voo nivelado e velocidade constante:", options: ["Sustentação > Peso.", "Sustentação = Peso e Tração = Arrasto.", "Tração > Arrasto.", "Peso > Sustentação."], answer: "Sustentação = Peso e Tração = Arrasto." },
    { question: "O ângulo formado entre a corda da asa e o vento relativo é o:", options: ["Ângulo de Incidência.", "Ângulo de Ataque.", "Ângulo de Diedro.", "Ângulo de Flecha."], answer: "Ângulo de Ataque." },
    { question: "A perda de sustentação por excesso de ângulo de ataque chama-se:", options: ["Arrasto.", "Estol (Stall).", "Mergulho.", "Voo planado."], answer: "Estol (Stall)." },
    { question: "O Arrasto Parasita é aquele causado por:", options: ["Geração de sustentação.", "Atrito do ar com as partes da aeronave (forma, interferência).", "Peso da aeronave.", "Motor."], answer: "Atrito do ar com as partes da aeronave (forma, interferência)." },
    { question: "O Arrasto Induzido é causado por:", options: ["Resistência frontal.", "Diferença de pressão nas pontas das asas (vórtices).", "Trem de pouso.", "Antenas."], answer: "Diferença de pressão nas pontas das asas (vórtices)." },
    { question: "Para reduzir o Arrasto Induzido, utiliza-se:", options: ["Flaps.", "Spoilers.", "Winglets.", "Slats."], answer: "Winglets." },
    { question: "O movimento em torno do eixo longitudinal é o:", options: ["Rolamento (Bancagem).", "Arfagem.", "Guinada.", "Subida."], answer: "Rolamento (Bancagem)." },
    { question: "O movimento em torno do eixo lateral (transversal) é a:", options: ["Rolamento.", "Arfagem (Tangagem).", "Guinada.", "Derrapagem."], answer: "Arfagem (Tangagem)." },
    { question: "O movimento em torno do eixo vertical é a:", options: ["Rolamento.", "Arfagem.", "Guinada.", "Mergulho."], answer: "Guinada." },
    { question: "A estabilidade lateral é dada principalmente pelo:", options: ["Diedro.", "Enflechamento.", "Leme.", "Profundor."], answer: "Diedro." },
    { question: "A estabilidade direcional é dada pelo:", options: ["Diedro.", "Estabilizador Vertical (Deriva).", "Estabilizador Horizontal.", "Asa."], answer: "Estabilizador Vertical (Deriva)." },
    { question: "A estabilidade longitudinal é dada pelo:", options: ["Diedro.", "Estabilizador Horizontal.", "Leme.", "Aileron."], answer: "Estabilizador Horizontal." },
    { question: "O enflechamento (asas para trás) serve principalmente para:", options: ["Aumentar a sustentação em baixa velocidade.", "Melhorar o desempenho em altas velocidades (atrasar o Mach Crítico).", "Diminuir o peso.", "Facilitar a construção."], answer: "Melhorar o desempenho em altas velocidades (atrasar o Mach Crítico)." },
    { question: "O Slat é um dispositivo hipersustentador que:", options: ["Aumenta a curvatura da asa atrás.", "Cria uma fenda no bordo de ataque para reenergizar o fluxo de ar.", "Freia o avião.", "Destrói sustentação."], answer: "Cria uma fenda no bordo de ataque para reenergizar o fluxo de ar." },
    { question: "Os Spoilers (Speed Brakes) servem para:", options: ["Aumentar a sustentação.", "Destruir a sustentação e aumentar o arrasto.", "Refrigerar o motor.", "Estabilizar o voo."], answer: "Destruir a sustentação e aumentar o arrasto." },
    { question: "O Compensador (Trim Tab) serve para:", options: ["Aumentar a potência.", "Aliviar os esforços do piloto nos comandos de voo.", "Frear o avião.", "Substituir o piloto automático."], answer: "Aliviar os esforços do piloto nos comandos de voo." },
    { question: "O Efeito Solo ocorre quando:", options: ["O avião está muito alto.", "O avião voa a uma altura menor que sua envergadura, aumentando a sustentação.", "O avião pousa na água.", "O motor toca o solo."], answer: "O avião voa a uma altura menor que sua envergadura, aumentando a sustentação." },
    { question: "A Guinada Adversa é causada pelo:", options: ["Uso do Leme.", "Arrasto maior na asa que sobe (uso dos ailerons).", "Vento de través.", "Motor."], answer: "Arrasto maior na asa que sobe (uso dos ailerons)." },
    { question: "Para corrigir a Guinada Adversa, o piloto usa:", options: ["Profundor.", "Flaps.", "Leme de Direção (Pé).", "Manche."], answer: "Leme de Direção (Pé)." },
    { question: "O Mach Crítico é a velocidade em que:", options: ["O avião atinge a velocidade do som.", "O fluxo de ar atinge a velocidade do som em algum ponto da aeronave.", "O avião estola.", "O motor para."], answer: "O fluxo de ar atinge a velocidade do som em algum ponto da aeronave." },
    { question: "O estrondo sônico (Sonic Boom) ocorre quando:", options: ["O avião decola.", "O avião ultrapassa a velocidade do som (Mach 1).", "O avião pousa.", "O motor explode."], answer: "O avião ultrapassa a velocidade do som (Mach 1)." },
    { question: "Motores Turboélice diferem dos Turbojatos pois:", options: ["Usam pistões.", "A maior parte da energia da turbina é usada para girar uma hélice.", "Não usam compressão.", "São mais rápidos que jatos."], answer: "A maior parte da energia da turbina é usada para girar uma hélice." },
    { question: "Motores Turbofan são mais eficientes que Jatos Puros porque:", options: ["Usam gasolina.", "Possuem um grande Fan frontal que gera a maior parte da tração (Bypass).", "Não têm turbina.", "São menores."], answer: "Possuem um grande Fan frontal que gera a maior parte da tração (Bypass)." },
    { question: "O sistema de Reverso nos motores a jato:", options: ["Faz a turbina girar ao contrário.", "Deflete o fluxo de ar para frente para auxiliar na frenagem.", "Usa paraquedas.", "Freia as rodas."], answer: "Deflete o fluxo de ar para frente para auxiliar na frenagem." },
    { question: "Passo Bandeira na hélice significa:", options: ["Passo mínimo.", "Pás alinhadas com o vento relativo para reduzir arrasto em caso de falha.", "Passo reverso.", "Hélice parada."], answer: "Pás alinhadas com o vento relativo para reduzir arrasto em caso de falha." },
    { question: "A Pressão Dinâmica é gerada pelo:", options: ["Peso do ar.", "Impacto do ar devido à velocidade.", "Calor.", "Altura."], answer: "Impacto do ar devido à velocidade." },
    { question: "O Tubo de Pitot fornece pressão total para o:", options: ["Altímetro.", "Velocímetro.", "Climb.", "Giro."], answer: "Velocímetro." },
    { question: "As tomadas estáticas fornecem pressão para:", options: ["Apenas Altímetro.", "Apenas Velocímetro.", "Altímetro, Velocímetro e Climb.", "Bússola."], answer: "Altímetro, Velocímetro e Climb." },
    { question: "Velocidade Calibrada (CAS) é a Velocidade Indicada corrigida para:", options: ["Erros de instalação e instrumento.", "Densidade.", "Temperatura.", "Vento."], answer: "Erros de instalação e instrumento." },
    { question: "Velocidade Verdadeira (TAS) é a Velocidade Calibrada corrigida para:", options: ["Erros de instrumento.", "Altitude e Temperatura (densidade do ar).", "Vento.", "Peso."], answer: "Altitude e Temperatura (densidade do ar)." },
    { question: "Velocidade no Solo (GS) é a Velocidade Verdadeira corrigida para:", options: ["Erros de instrumento.", "Densidade.", "O efeito do vento.", "Temperatura."], answer: "O efeito do vento." },
    { question: "A VNE (Velocidade Nunca Exceder) é limitada por:", options: ["Potência do motor.", "Estrutura da aeronave (integridade).", "Combustível.", "Piloto."], answer: "Estrutura da aeronave (integridade)." },
    { question: "O Centro de Gravidade (CG) deve estar localizado:", options: ["No nariz.", "Na cauda.", "Dentro dos limites estabelecidos pelo fabricante.", "Nas asas."], answer: "Dentro dos limites estabelecidos pelo fabricante." },
    { question: "Uma aeronave com CG muito atrás (cauda pesada) torna-se:", options: ["Mais estável.", "Instável longitudinalmente e difícil de recuperar de estol.", "Mais rápida.", "Mais econômica."], answer: "Instável longitudinalmente e difícil de recuperar de estol." },
    { question: "A força que faz o avião girar em torno de seus eixos chama-se:", options: ["Momento.", "Peso.", "Inércia.", "Tração."], answer: "Momento." },
    { question: "Slot é uma fenda fixa, enquanto Slat é:", options: ["Fixo.", "Móvel.", "De freio.", "De cauda."], answer: "Móvel." },
    { question: "O perfil de asa Simétrico:", options: ["Não produz sustentação com ângulo de ataque zero.", "Produz muita sustentação.", "É curvo em cima.", "É usado em cargueiros."], answer: "Não produz sustentação com ângulo de ataque zero." },
    { question: "O perfil de asa Assimétrico:", options: ["Tem curvaturas iguais.", "Produz sustentação mesmo com ângulo de ataque zero.", "Não sustenta.", "É plano."], answer: "Produz sustentação mesmo com ângulo de ataque zero." },
    { question: "A 'Corda' de um perfil é a linha que liga:", options: ["As pontas das asas.", "O bordo de ataque ao bordo de fuga.", "O dorso ao ventre.", "A fuselagem ao motor."], answer: "O bordo de ataque ao bordo de fuga." },
    { question: "Ângulo de Incidência é um ângulo:", options: ["Aerodinâmico (variável).", "De construção (fixo).", "De voo.", "De manobra."], answer: "De construção (fixo)." },
    { question: "O fator carga (G) aumenta durante:", options: ["Voo nivelado.", "Curvas e recuperações de mergulho.", "Descidas.", "Táxi."], answer: "Curvas e recuperações de mergulho." },
    { question: "Os descarregadores estáticos servem para:", options: ["Evitar raios.", "Dissipar eletricidade estática acumulada na fuselagem.", "Melhorar o rádio.", "Sinalização."], answer: "Dissipar eletricidade estática acumulada na fuselagem." },
    { question: "O sistema anti-skid (ABS) serve para:", options: ["Frear mais rápido.", "Evitar o travamento das rodas e derrapagens.", "Virar o avião.", "Recolher o trem."], answer: "Evitar o travamento das rodas e derrapagens." },
    { question: "A hélice de passo variável permite:", options: ["Ajustar o ângulo das pás para melhor eficiência em diferentes fases do voo.", "Apenas passo fixo.", "Mudar a cor.", "Aumentar o tamanho."], answer: "Ajustar o ângulo das pás para melhor eficiência em diferentes fases do voo." },
    { question: "O altímetro funciona medindo a:", options: ["Pressão Dinâmica.", "Pressão Estática.", "Temperatura.", "Umidade."], answer: "Pressão Estática." },
    { question: "A altitude pressão é a altitude lida com o altímetro ajustado em:", options: ["QNH (Local).", "QFE (Campo).", "QNE (1013.2 hPa / Padrão).", "Zero."], answer: "QNE (1013.2 hPa / Padrão)." },
    { question: "O Climb (Variômetro) indica:", options: ["Velocidade horizontal.", "Razão de subida ou descida (velocidade vertical).", "Curva.", "Altitude."], answer: "Razão de subida ou descida (velocidade vertical)." },
    { question: "A 'Atmosfera Padrão' (ISA) considera ao nível do mar:", options: ["15°C e 1013.2 hPa.", "25°C e 1000 hPa.", "0°C e 760 mmHg.", "30°C e 1013 hPa."], answer: "15°C e 1013.2 hPa." }
];